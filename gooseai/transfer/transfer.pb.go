...
type TransferRequest struct {
	...
	OrgId           string   `protobuf:"bytes,2,opt,name=org_id,json=orgId,proto3" json:"org_id,omitempty"`                                   // org_id of the user who is requesting the transfer
	FineTuningJobId string   `protobuf:"bytes,3,opt,name=fine_tuning_job_id,json=fineTuningJobId,proto3" json:"fine_tuning_job_id,omitempty"` // the id of the fine tuning job
	SourceUrls      []string `protobuf:"bytes,4,rep,name=source_urls,json=sourceUrls,proto3" json:"source_urls,omitempty"`                    // a list of urls to the assets to be transferred
}
...
func (x *TransferRequest) GetOrgId() string {
	if x != nil {
		return x.OrgId
	}
	return ""
...
type TransferResponse struct {
	...
	Urls []string `protobuf:"bytes,1,rep,name=urls,proto3" json:"urls,omitempty"` // the list of transferred assets in their destination location
}
...
var file_transfer_proto_rawDesc = []byte{
	...
	0x12, 0x07, 0x67, 0x6f, 0x6f, 0x73, 0x65, 0x61, 0x69, 0x22, 0x8f, 0x01, 0x0a, 0x0f, 0x54, 0x72,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6f, 0x72, 0x67, 0x49, 0x64, 0x12, 0x2b, 0x0a,
	0x12, 0x66, 0x69, 0x6e, 0x65, 0x5f, 0x74, 0x75, 0x6e, 0x69, 0x6e, 0x67, 0x5f, 0x6a, 0x6f, 0x62,
	0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x66, 0x69, 0x6e, 0x65, 0x54,
	0x75, 0x6e, 0x69, 0x6e, 0x67, 0x4a, 0x6f, 0x62, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x5f, 0x75, 0x72, 0x6c, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52,
	0x0a, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x55, 0x72, 0x6c, 0x73, 0x22, 0x26, 0x0a, 0x10, 0x54,
	...
	0x72, 0x6c, 0x73, 0x32, 0x54, 0x0a, 0x0f, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x53,
	...
	0x63, 0x65, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x73, 0x65, 0x61, 0x69, 0x2f, 0x74, 0x72, 0x61, 0x6e,
