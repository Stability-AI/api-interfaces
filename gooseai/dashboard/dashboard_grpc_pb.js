...
function serialize_gooseai_APIKey(arg) {
  if (!(arg instanceof dashboard_dashboard_pb.APIKey)) {
...
function deserialize_gooseai_APIKey(buffer_arg) {
  return dashboard_dashboard_pb.APIKey.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_APIKeyFindRequest(arg) {
  if (!(arg instanceof dashboard_dashboard_pb.APIKeyFindRequest)) {
...
function deserialize_gooseai_APIKeyFindRequest(buffer_arg) {
  return dashboard_dashboard_pb.APIKeyFindRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_APIKeyRequest(arg) {
  if (!(arg instanceof dashboard_dashboard_pb.APIKeyRequest)) {
...
function deserialize_gooseai_APIKeyRequest(buffer_arg) {
  return dashboard_dashboard_pb.APIKeyRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_AutoChargeIntent(arg) {
  if (!(arg instanceof dashboard_dashboard_pb.AutoChargeIntent)) {
...
function deserialize_gooseai_AutoChargeIntent(buffer_arg) {
  return dashboard_dashboard_pb.AutoChargeIntent.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_Charge(arg) {
  if (!(arg instanceof dashboard_dashboard_pb.Charge)) {
...
function deserialize_gooseai_Charge(buffer_arg) {
  return dashboard_dashboard_pb.Charge.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_Charges(arg) {
  if (!(arg instanceof dashboard_dashboard_pb.Charges)) {
...
function deserialize_gooseai_Charges(buffer_arg) {
  return dashboard_dashboard_pb.Charges.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_ClientSettings(arg) {
  if (!(arg instanceof dashboard_dashboard_pb.ClientSettings)) {
...
function deserialize_gooseai_ClientSettings(buffer_arg) {
  return dashboard_dashboard_pb.ClientSettings.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_CreateAutoChargeIntentRequest(arg) {
  if (!(arg instanceof dashboard_dashboard_pb.CreateAutoChargeIntentRequest)) {
...
function deserialize_gooseai_CreateAutoChargeIntentRequest(buffer_arg) {
  return dashboard_dashboard_pb.CreateAutoChargeIntentRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_CreateChargeRequest(arg) {
  if (!(arg instanceof dashboard_dashboard_pb.CreateChargeRequest)) {
...
function deserialize_gooseai_CreateChargeRequest(buffer_arg) {
  return dashboard_dashboard_pb.CreateChargeRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_EmptyRequest(arg) {
  if (!(arg instanceof dashboard_dashboard_pb.EmptyRequest)) {
...
function deserialize_gooseai_EmptyRequest(buffer_arg) {
  return dashboard_dashboard_pb.EmptyRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_GetAutoChargeRequest(arg) {
  if (!(arg instanceof dashboard_dashboard_pb.GetAutoChargeRequest)) {
...
function deserialize_gooseai_GetAutoChargeRequest(buffer_arg) {
  return dashboard_dashboard_pb.GetAutoChargeRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_GetChargesRequest(arg) {
  if (!(arg instanceof dashboard_dashboard_pb.GetChargesRequest)) {
...
function deserialize_gooseai_GetChargesRequest(buffer_arg) {
  return dashboard_dashboard_pb.GetChargesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_GetMetricsRequest(arg) {
  if (!(arg instanceof dashboard_dashboard_pb.GetMetricsRequest)) {
...
function deserialize_gooseai_GetMetricsRequest(buffer_arg) {
  return dashboard_dashboard_pb.GetMetricsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_GetOrganizationRequest(arg) {
  if (!(arg instanceof dashboard_dashboard_pb.GetOrganizationRequest)) {
...
function deserialize_gooseai_GetOrganizationRequest(buffer_arg) {
  return dashboard_dashboard_pb.GetOrganizationRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_Metrics(arg) {
  if (!(arg instanceof dashboard_dashboard_pb.Metrics)) {
...
function deserialize_gooseai_Metrics(buffer_arg) {
  return dashboard_dashboard_pb.Metrics.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_Organization(arg) {
  if (!(arg instanceof dashboard_dashboard_pb.Organization)) {
...
function deserialize_gooseai_Organization(buffer_arg) {
  return dashboard_dashboard_pb.Organization.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_UpdateDefaultOrganizationRequest(arg) {
  if (!(arg instanceof dashboard_dashboard_pb.UpdateDefaultOrganizationRequest)) {
...
function deserialize_gooseai_UpdateDefaultOrganizationRequest(buffer_arg) {
  return dashboard_dashboard_pb.UpdateDefaultOrganizationRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_UpdateUserInfoRequest(arg) {
  if (!(arg instanceof dashboard_dashboard_pb.UpdateUserInfoRequest)) {
...
function deserialize_gooseai_UpdateUserInfoRequest(buffer_arg) {
  return dashboard_dashboard_pb.UpdateUserInfoRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_User(arg) {
  if (!(arg instanceof dashboard_dashboard_pb.User)) {
...
function deserialize_gooseai_User(buffer_arg) {
  return dashboard_dashboard_pb.User.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_UserPasswordChangeTicket(arg) {
  if (!(arg instanceof dashboard_dashboard_pb.UserPasswordChangeTicket)) {
...
function deserialize_gooseai_UserPasswordChangeTicket(buffer_arg) {
  return dashboard_dashboard_pb.UserPasswordChangeTicket.deserializeBinary(new Uint8Array(buffer_arg));
}
