...
DashboardService.AcceptLegalTerms = {
...
DashboardService.UpdateUserPreferences = {
...
DashboardServiceClient.prototype.acceptLegalTerms = function acceptLegalTerms(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(DashboardService.AcceptLegalTerms, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
DashboardServiceClient.prototype.updateUserPreferences = function updateUserPreferences(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(DashboardService.UpdateUserPreferences, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
