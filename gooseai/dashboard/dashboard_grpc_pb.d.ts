...
interface IDashboardServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  listOrganizationMembers: grpc.MethodDefinition<dashboard_pb.ListOrganizationMembersRequest, dashboard_pb.OrganizationMember>;
  removeOrganizationMember: grpc.MethodDefinition<dashboard_pb.RemoveOrganizationMemberRequest, dashboard_pb.RemoveOrganizationMemberResponse>;
  addOrganizationMember: grpc.MethodDefinition<dashboard_pb.AddOrganizationMemberRequest, dashboard_pb.OrganizationMember>;
  updateOrganizationMember: grpc.MethodDefinition<dashboard_pb.UpdateOrganizationMemberRequest, dashboard_pb.OrganizationMember>;
...
export interface IDashboardServiceServer extends grpc.UntypedServiceImplementation {
  ...
  listOrganizationMembers: grpc.handleServerStreamingCall<dashboard_pb.ListOrganizationMembersRequest, dashboard_pb.OrganizationMember>;
  removeOrganizationMember: grpc.handleUnaryCall<dashboard_pb.RemoveOrganizationMemberRequest, dashboard_pb.RemoveOrganizationMemberResponse>;
  addOrganizationMember: grpc.handleUnaryCall<dashboard_pb.AddOrganizationMemberRequest, dashboard_pb.OrganizationMember>;
  updateOrganizationMember: grpc.handleUnaryCall<dashboard_pb.UpdateOrganizationMemberRequest, dashboard_pb.OrganizationMember>;
...
export class DashboardServiceClient extends grpc.Client {
  ...
  listOrganizationMembers(argument: dashboard_pb.ListOrganizationMembersRequest, metadataOrOptions?: grpc.Metadata | grpc.CallOptions | null): grpc.ClientReadableStream<dashboard_pb.OrganizationMember>;
  listOrganizationMembers(argument: dashboard_pb.ListOrganizationMembersRequest, metadata?: grpc.Metadata | null, options?: grpc.CallOptions | null): grpc.ClientReadableStream<dashboard_pb.OrganizationMember>;
  removeOrganizationMember(argument: dashboard_pb.RemoveOrganizationMemberRequest, callback: grpc.requestCallback<dashboard_pb.RemoveOrganizationMemberResponse>): grpc.ClientUnaryCall;
  removeOrganizationMember(argument: dashboard_pb.RemoveOrganizationMemberRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<dashboard_pb.RemoveOrganizationMemberResponse>): grpc.ClientUnaryCall;
  removeOrganizationMember(argument: dashboard_pb.RemoveOrganizationMemberRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<dashboard_pb.RemoveOrganizationMemberResponse>): grpc.ClientUnaryCall;
  addOrganizationMember(argument: dashboard_pb.AddOrganizationMemberRequest, callback: grpc.requestCallback<dashboard_pb.OrganizationMember>): grpc.ClientUnaryCall;
  addOrganizationMember(argument: dashboard_pb.AddOrganizationMemberRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<dashboard_pb.OrganizationMember>): grpc.ClientUnaryCall;
  addOrganizationMember(argument: dashboard_pb.AddOrganizationMemberRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<dashboard_pb.OrganizationMember>): grpc.ClientUnaryCall;
  updateOrganizationMember(argument: dashboard_pb.UpdateOrganizationMemberRequest, callback: grpc.requestCallback<dashboard_pb.OrganizationMember>): grpc.ClientUnaryCall;
  updateOrganizationMember(argument: dashboard_pb.UpdateOrganizationMemberRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<dashboard_pb.OrganizationMember>): grpc.ClientUnaryCall;
  updateOrganizationMember(argument: dashboard_pb.UpdateOrganizationMemberRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<dashboard_pb.OrganizationMember>): grpc.ClientUnaryCall;
