...
goog.exportSymbol('proto.gooseai.APIKeyRequestScope', null, global);
goog.exportSymbol('proto.gooseai.APIKeyScope', null, global);
...
goog.exportSymbol('proto.gooseai.ListAPIKeyScopesRequest', null, global);
goog.exportSymbol('proto.gooseai.ListAPIKeyScopesResponse', null, global);
...
proto.gooseai.APIKey = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.gooseai.APIKey.repeatedFields_, null);
};
 ...
 * @constructor
 */
proto.gooseai.APIKeyScope = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.gooseai.APIKeyScope, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.gooseai.APIKeyScope.displayName = 'proto.gooseai.APIKeyScope';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.gooseai.ListAPIKeyScopesRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.gooseai.ListAPIKeyScopesRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.gooseai.ListAPIKeyScopesRequest.displayName = 'proto.gooseai.ListAPIKeyScopesRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.gooseai.ListAPIKeyScopesResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.gooseai.ListAPIKeyScopesResponse.repeatedFields_, null);
};
goog.inherits(proto.gooseai.ListAPIKeyScopesResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.gooseai.ListAPIKeyScopesResponse.displayName = 'proto.gooseai.ListAPIKeyScopesResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.gooseai.APIKeyRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.gooseai.APIKeyRequest.repeatedFields_, null);
};
 ...
 * @constructor
 */
proto.gooseai.APIKeyRequestScope = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.gooseai.APIKeyRequestScope, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.gooseai.APIKeyRequestScope.displayName = 'proto.gooseai.APIKeyRequestScope';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.gooseai.APIKey.repeatedFields_ = [4];
...
proto.gooseai.APIKey.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.gooseai.APIKeyScope.toObject, includeInstance)
  };
...
proto.gooseai.APIKey.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new proto.gooseai.APIKeyScope;
      reader.readMessage(value,proto.gooseai.APIKeyScope.deserializeBinaryFromReader);
      msg.addScopes(value);
      break;
    default:
      reader.skipField();
...
proto.gooseai.APIKey.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      4,
      f,
      proto.gooseai.APIKeyScope.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated APIKeyScope scopes = 4;
 * @return {!Array<!proto.gooseai.APIKeyScope>}
 */
proto.gooseai.APIKey.prototype.getScopesList = function() {
  return /** @type{!Array<!proto.gooseai.APIKeyScope>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.gooseai.APIKeyScope, 4));
};


/**
 * @param {!Array<!proto.gooseai.APIKeyScope>} value
 * @return {!proto.gooseai.APIKey} returns this
*/
proto.gooseai.APIKey.prototype.setScopesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 4, value);
};


/**
 * @param {!proto.gooseai.APIKeyScope=} opt_value
 * @param {number=} opt_index
 * @return {!proto.gooseai.APIKeyScope}
 */
proto.gooseai.APIKey.prototype.addScopes = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.gooseai.APIKeyScope, opt_index);
};
 ...
 * @return {!proto.gooseai.APIKey} returns this
 */
proto.gooseai.APIKey.prototype.clearScopesList = function() {
 ...
 * @return {!Object}
 */
proto.gooseai.APIKeyScope.prototype.toObject = function(opt_includeInstance) {
  return proto.gooseai.APIKeyScope.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gooseai.APIKeyScope} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.APIKeyScope.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.gooseai.APIKeyScope}
 */
proto.gooseai.APIKeyScope.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gooseai.APIKeyScope;
  return proto.gooseai.APIKeyScope.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gooseai.APIKeyScope} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gooseai.APIKeyScope}
 */
proto.gooseai.APIKeyScope.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.gooseai.APIKeyScope.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gooseai.APIKeyScope.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gooseai.APIKeyScope} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.APIKeyScope.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getScope();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.gooseai.APIKeyScope.prototype.getScope = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.gooseai.APIKeyScope} returns this
 */
proto.gooseai.APIKeyScope.prototype.setScope = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.gooseai.APIKeyScope.prototype.getDescription = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.gooseai.APIKeyScope} returns this
 */
proto.gooseai.APIKeyScope.prototype.setDescription = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.gooseai.ListAPIKeyScopesRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.gooseai.ListAPIKeyScopesRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gooseai.ListAPIKeyScopesRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.ListAPIKeyScopesRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.gooseai.ListAPIKeyScopesRequest}
 */
proto.gooseai.ListAPIKeyScopesRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gooseai.ListAPIKeyScopesRequest;
  return proto.gooseai.ListAPIKeyScopesRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gooseai.ListAPIKeyScopesRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gooseai.ListAPIKeyScopesRequest}
 */
proto.gooseai.ListAPIKeyScopesRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.gooseai.ListAPIKeyScopesRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gooseai.ListAPIKeyScopesRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gooseai.ListAPIKeyScopesRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.ListAPIKeyScopesRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @const
 */
proto.gooseai.ListAPIKeyScopesResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.gooseai.ListAPIKeyScopesResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.gooseai.ListAPIKeyScopesResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gooseai.ListAPIKeyScopesResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.ListAPIKeyScopesResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    scopesList: jspb.Message.toObjectList(msg.getScopesList(),
    proto.gooseai.APIKeyScope.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.gooseai.ListAPIKeyScopesResponse}
 */
proto.gooseai.ListAPIKeyScopesResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gooseai.ListAPIKeyScopesResponse;
  return proto.gooseai.ListAPIKeyScopesResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gooseai.ListAPIKeyScopesResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gooseai.ListAPIKeyScopesResponse}
 */
proto.gooseai.ListAPIKeyScopesResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.gooseai.ListAPIKeyScopesResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gooseai.ListAPIKeyScopesResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gooseai.ListAPIKeyScopesResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.ListAPIKeyScopesResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getScopesList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
...
/**
 * repeated APIKeyScope scopes = 1;
 * @return {!Array<!proto.gooseai.APIKeyScope>}
 */
proto.gooseai.ListAPIKeyScopesResponse.prototype.getScopesList = function() {
  return /** @type{!Array<!proto.gooseai.APIKeyScope>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.gooseai.APIKeyScope, 1));
};


/**
 * @param {!Array<!proto.gooseai.APIKeyScope>} value
 * @return {!proto.gooseai.ListAPIKeyScopesResponse} returns this
*/
proto.gooseai.ListAPIKeyScopesResponse.prototype.setScopesList = function(value) {
 ...
 * @return {!proto.gooseai.APIKeyScope}
 */
proto.gooseai.ListAPIKeyScopesResponse.prototype.addScopes = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.gooseai.APIKeyScope, opt_index);
};
 ...
 * @return {!proto.gooseai.ListAPIKeyScopesResponse} returns this
 */
proto.gooseai.ListAPIKeyScopesResponse.prototype.clearScopesList = function() {
  return this.setScopesList([]);
};
 ...
 * @const
 */
proto.gooseai.APIKeyRequest.repeatedFields_ = [2];
...
proto.gooseai.APIKeyRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    scopesList: jspb.Message.toObjectList(msg.getScopesList(),
    proto.gooseai.APIKeyRequestScope.toObject, includeInstance)
  };
...
proto.gooseai.APIKeyRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.gooseai.APIKeyRequestScope;
      reader.readMessage(value,proto.gooseai.APIKeyRequestScope.deserializeBinaryFromReader);
      msg.addScopes(value);
      break;
    default:
      reader.skipField();
...
proto.gooseai.APIKeyRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.gooseai.APIKeyRequestScope.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated APIKeyRequestScope scopes = 2;
 * @return {!Array<!proto.gooseai.APIKeyRequestScope>}
 */
proto.gooseai.APIKeyRequest.prototype.getScopesList = function() {
  return /** @type{!Array<!proto.gooseai.APIKeyRequestScope>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.gooseai.APIKeyRequestScope, 2));
};


/**
 * @param {!Array<!proto.gooseai.APIKeyRequestScope>} value
 * @return {!proto.gooseai.APIKeyRequest} returns this
*/
proto.gooseai.APIKeyRequest.prototype.setScopesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 2, value);
};


/**
 * @param {!proto.gooseai.APIKeyRequestScope=} opt_value
 * @param {number=} opt_index
 * @return {!proto.gooseai.APIKeyRequestScope}
 */
proto.gooseai.APIKeyRequest.prototype.addScopes = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.gooseai.APIKeyRequestScope, opt_index);
};
 ...
 * @return {!proto.gooseai.APIKeyRequest} returns this
 */
proto.gooseai.APIKeyRequest.prototype.clearScopesList = function() {
  return this.setScopesList([]);
};
 ...
 * @return {!Object}
 */
proto.gooseai.APIKeyRequestScope.prototype.toObject = function(opt_includeInstance) {
  return proto.gooseai.APIKeyRequestScope.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gooseai.APIKeyRequestScope} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.APIKeyRequestScope.toObject = function(includeInstance, msg) {
  var f, obj = {
    scope: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * @return {!proto.gooseai.APIKeyRequestScope}
 */
proto.gooseai.APIKeyRequestScope.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gooseai.APIKeyRequestScope;
  return proto.gooseai.APIKeyRequestScope.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gooseai.APIKeyRequestScope} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gooseai.APIKeyRequestScope}
 */
proto.gooseai.APIKeyRequestScope.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.gooseai.APIKeyRequestScope.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gooseai.APIKeyRequestScope.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gooseai.APIKeyRequestScope} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.APIKeyRequestScope.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getScope();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.gooseai.APIKeyRequestScope.prototype.getScope = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.gooseai.APIKeyRequestScope} returns this
 */
proto.gooseai.APIKeyRequestScope.prototype.setScope = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
