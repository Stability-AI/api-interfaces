...
interface IGenerationServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  ...
  batchGenerate: grpc.MethodDefinition<generation_pb.BatchRequest, generation_pb.AnswerBatch>;
}
...
export interface IGenerationServiceServer extends grpc.UntypedServiceImplementation {
  ...
  batchGenerate: grpc.handleUnaryCall<generation_pb.BatchRequest, generation_pb.AnswerBatch>;
}
...
export class GenerationServiceClient extends grpc.Client {
  ...
  batchGenerate(argument: generation_pb.BatchRequest, callback: grpc.requestCallback<generation_pb.AnswerBatch>): grpc.ClientUnaryCall;
  batchGenerate(argument: generation_pb.BatchRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<generation_pb.AnswerBatch>): grpc.ClientUnaryCall;
  batchGenerate(argument: generation_pb.BatchRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<generation_pb.AnswerBatch>): grpc.ClientUnaryCall;
}
