...
goog.exportSymbol('proto.gooseai.CameraSettings', null, global);
...
goog.exportSymbol('proto.gooseai.MeshRenderSettings', null, global);
...
goog.exportSymbol('proto.gooseai.PointCloudRenderSettings', null, global);
...
goog.exportSymbol('proto.gooseai.RenderSettings', null, global);
goog.exportSymbol('proto.gooseai.RenderSettings.RenderSettingsCase', null, global);
 ...
 * @constructor
 */
proto.gooseai.PointCloudRenderSettings = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.gooseai.PointCloudRenderSettings, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.gooseai.PointCloudRenderSettings.displayName = 'proto.gooseai.PointCloudRenderSettings';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.gooseai.MeshRenderSettings = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.gooseai.MeshRenderSettings, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.gooseai.MeshRenderSettings.displayName = 'proto.gooseai.MeshRenderSettings';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.gooseai.RenderSettings = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.gooseai.RenderSettings.oneofGroups_);
};
goog.inherits(proto.gooseai.RenderSettings, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.gooseai.RenderSettings.displayName = 'proto.gooseai.RenderSettings';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.gooseai.CameraSettings = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.gooseai.CameraSettings, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.gooseai.CameraSettings.displayName = 'proto.gooseai.CameraSettings';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.gooseai.PointCloudRenderSettings.prototype.toObject = function(opt_includeInstance) {
  return proto.gooseai.PointCloudRenderSettings.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gooseai.PointCloudRenderSettings} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.PointCloudRenderSettings.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.gooseai.PointCloudRenderSettings}
 */
proto.gooseai.PointCloudRenderSettings.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gooseai.PointCloudRenderSettings;
  return proto.gooseai.PointCloudRenderSettings.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gooseai.PointCloudRenderSettings} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gooseai.PointCloudRenderSettings}
 */
proto.gooseai.PointCloudRenderSettings.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.gooseai.PointCloudRenderSettings.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gooseai.PointCloudRenderSettings.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gooseai.PointCloudRenderSettings} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.PointCloudRenderSettings.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getRadius();
  if (f !== 0.0) {
    writer.writeFloat(
 ...
 * @return {number}
 */
proto.gooseai.PointCloudRenderSettings.prototype.getRadius = function() {
  return /** @type {number} */ (jspb.Message.getFloatingPointFieldWithDefault(this, 1, 0.0));
};
...
/**
 * @param {number} value
 * @return {!proto.gooseai.PointCloudRenderSettings} returns this
 */
proto.gooseai.PointCloudRenderSettings.prototype.setRadius = function(value) {
  return jspb.Message.setProto3FloatField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.gooseai.PointCloudRenderSettings.prototype.getPointsPerPixel = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.gooseai.PointCloudRenderSettings} returns this
 */
proto.gooseai.PointCloudRenderSettings.prototype.setPointsPerPixel = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.gooseai.MeshRenderSettings.prototype.toObject = function(opt_includeInstance) {
  return proto.gooseai.MeshRenderSettings.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gooseai.MeshRenderSettings} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.gooseai.MeshRenderSettings}
 */
proto.gooseai.MeshRenderSettings.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gooseai.MeshRenderSettings;
  return proto.gooseai.MeshRenderSettings.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gooseai.MeshRenderSettings} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gooseai.MeshRenderSettings}
 */
proto.gooseai.MeshRenderSettings.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.gooseai.MeshRenderSettings.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gooseai.MeshRenderSettings.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gooseai.MeshRenderSettings} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * @const
 */
proto.gooseai.RenderSettings.oneofGroups_ = [[1,2]];

/**
 * @enum {number}
 */
proto.gooseai.RenderSettings.RenderSettingsCase = {
  RENDER_SETTINGS_NOT_SET: 0,
  POINTCLOUD_SETTINGS: 1,
  MESH_SETTINGS: 2
};

/**
 * @return {proto.gooseai.RenderSettings.RenderSettingsCase}
 */
proto.gooseai.RenderSettings.prototype.getRenderSettingsCase = function() {
  return /** @type {proto.gooseai.RenderSettings.RenderSettingsCase} */(jspb.Message.computeOneofCase(this, proto.gooseai.RenderSettings.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.gooseai.RenderSettings.prototype.toObject = function(opt_includeInstance) {
  return proto.gooseai.RenderSettings.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gooseai.RenderSettings} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.RenderSettings.toObject = function(includeInstance, msg) {
  var f, obj = {
    pointcloudSettings: (f = msg.getPointcloudSettings()) && proto.gooseai.PointCloudRenderSettings.toObject(includeInstance, f),
    meshSettings: (f = msg.getMeshSettings()) && proto.gooseai.MeshRenderSettings.toObject(includeInstance, f)
  };
 ...
 */
proto.gooseai.RenderSettings.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gooseai.RenderSettings;
  return proto.gooseai.RenderSettings.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gooseai.RenderSettings} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gooseai.RenderSettings}
 */
proto.gooseai.RenderSettings.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.gooseai.PointCloudRenderSettings;
      reader.readMessage(value,proto.gooseai.PointCloudRenderSettings.deserializeBinaryFromReader);
      msg.setPointcloudSettings(value);
      break;
    case 2:
      var value = new proto.gooseai.MeshRenderSettings;
      reader.readMessage(value,proto.gooseai.MeshRenderSettings.deserializeBinaryFromReader);
      msg.setMeshSettings(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.gooseai.RenderSettings.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gooseai.RenderSettings.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gooseai.RenderSettings} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.RenderSettings.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPointcloudSettings();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.gooseai.PointCloudRenderSettings.serializeBinaryToWriter
    );
  }
  f = message.getMeshSettings();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.gooseai.MeshRenderSettings.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional PointCloudRenderSettings pointcloud_settings = 1;
 * @return {?proto.gooseai.PointCloudRenderSettings}
 */
proto.gooseai.RenderSettings.prototype.getPointcloudSettings = function() {
  return /** @type{?proto.gooseai.PointCloudRenderSettings} */ (
    jspb.Message.getWrapperField(this, proto.gooseai.PointCloudRenderSettings, 1));
};


/**
 * @param {?proto.gooseai.PointCloudRenderSettings|undefined} value
 * @return {!proto.gooseai.RenderSettings} returns this
*/
proto.gooseai.RenderSettings.prototype.setPointcloudSettings = function(value) {
  return jspb.Message.setOneofWrapperField(this, 1, proto.gooseai.RenderSettings.oneofGroups_[0], value);
};
 ...
 * @return {!proto.gooseai.RenderSettings} returns this
 */
proto.gooseai.RenderSettings.prototype.clearPointcloudSettings = function() {
  return this.setPointcloudSettings(undefined);
};
 ...
 * @return {boolean}
 */
proto.gooseai.RenderSettings.prototype.hasPointcloudSettings = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional MeshRenderSettings mesh_settings = 2;
 * @return {?proto.gooseai.MeshRenderSettings}
 */
proto.gooseai.RenderSettings.prototype.getMeshSettings = function() {
  return /** @type{?proto.gooseai.MeshRenderSettings} */ (
    jspb.Message.getWrapperField(this, proto.gooseai.MeshRenderSettings, 2));
};


/**
 * @param {?proto.gooseai.MeshRenderSettings|undefined} value
 * @return {!proto.gooseai.RenderSettings} returns this
*/
proto.gooseai.RenderSettings.prototype.setMeshSettings = function(value) {
  return jspb.Message.setOneofWrapperField(this, 2, proto.gooseai.RenderSettings.oneofGroups_[0], value);
};
 ...
 * @return {!proto.gooseai.RenderSettings} returns this
 */
proto.gooseai.RenderSettings.prototype.clearMeshSettings = function() {
  return this.setMeshSettings(undefined);
};
 ...
 * @return {boolean}
 */
proto.gooseai.RenderSettings.prototype.hasMeshSettings = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {!Object}
 */
proto.gooseai.CameraSettings.prototype.toObject = function(opt_includeInstance) {
  return proto.gooseai.CameraSettings.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gooseai.CameraSettings} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.gooseai.CameraSettings}
 */
proto.gooseai.CameraSettings.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gooseai.CameraSettings;
  return proto.gooseai.CameraSettings.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gooseai.CameraSettings} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gooseai.CameraSettings}
 */
proto.gooseai.CameraSettings.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.gooseai.CameraSettings.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gooseai.CameraSettings.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gooseai.CameraSettings} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
...
proto.gooseai.TransformCameraPose.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.gooseai.CameraSettings;
      reader.readMessage(value,proto.gooseai.CameraSettings.deserializeBinaryFromReader);
...
/**
 * optional CameraSettings camera_settings = 2;
 * @return {?proto.gooseai.CameraSettings}
 */
proto.gooseai.TransformCameraPose.prototype.getCameraSettings = function() {
  return /** @type{?proto.gooseai.CameraSettings} */ (
    jspb.Message.getWrapperField(this, proto.gooseai.CameraSettings, 2));
};


/**
 * @param {?proto.gooseai.CameraSettings|undefined} value
 * @return {!proto.gooseai.TransformCameraPose} returns this
*/
proto.gooseai.TransformCameraPose.prototype.setCameraSettings = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.gooseai.TransformCameraPose} returns this
 */
proto.gooseai.TransformCameraPose.prototype.clearCameraSettings = function() {
 ...
 * @return {boolean}
 */
proto.gooseai.TransformCameraPose.prototype.hasCameraSettings = function() {
  return jspb.Message.getField(this, 2) != null;
};
...
/**
 * @param {?proto.gooseai.RenderSettings|undefined} value
 * @return {!proto.gooseai.TransformCameraPose} returns this
*/
 ...
 * @return {!proto.gooseai.TransformCameraPose} returns this
 */
proto.gooseai.TransformCameraPose.prototype.clearImageRenderSettings = function() {
  return this.setImageRenderSettings(undefined);
};
 ...
 * @return {!proto.gooseai.TransformCameraPose} returns this
 */
proto.gooseai.TransformCameraPose.prototype.clearMaskRenderSettings = function() {
  return this.setMaskRenderSettings(undefined);
};
 ...
 * @const
 */
proto.gooseai.TransformParameters.oneofGroups_ = [[1,2,3,4,5,6]];
