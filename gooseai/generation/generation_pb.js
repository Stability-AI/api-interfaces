...
goog.exportSymbol('proto.gooseai.GuidanceType', null, global);
...
proto.gooseai.GuidanceParameters.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    guidancePreset: jspb.Message.getFieldWithDefault(msg, 2, 0),
...
proto.gooseai.GuidanceParameters.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.gooseai.GuidanceType} */ (reader.readEnum());
      msg.setType(value);
      break;
    case 2:
...
proto.gooseai.GuidanceParameters.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = /** @type {!proto.gooseai.GuidanceType} */ (jspb.Message.getField(message, 1));
  if (f != null) {
    writer.writeEnum(
      1,
      f
  ...
  f = /** @type {!proto.gooseai.GuidancePreset} */ (jspb.Message.getField(message, 2));
  if (f != null) {
    writer.writeEnum(
      2,
      f
...
/**
 * optional GuidanceType type = 1;
 * @return {!proto.gooseai.GuidanceType}
 */
proto.gooseai.GuidanceParameters.prototype.getType = function() {
  return /** @type {!proto.gooseai.GuidanceType} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.gooseai.GuidanceType} value
 * @return {!proto.gooseai.GuidanceParameters} returns this
 */
proto.gooseai.GuidanceParameters.prototype.setType = function(value) {
  return jspb.Message.setField(this, 1, value);
};
 ...
 * @return {!proto.gooseai.GuidanceParameters} returns this
 */
proto.gooseai.GuidanceParameters.prototype.clearType = function() {
  return jspb.Message.setField(this, 1, undefined);
};
 ...
 * @return {boolean}
 */
proto.gooseai.GuidanceParameters.prototype.hasType = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional GuidancePreset guidance_preset = 2;
 * @return {!proto.gooseai.GuidancePreset}
 */
proto.gooseai.GuidanceParameters.prototype.getGuidancePreset = function() {
  return /** @type {!proto.gooseai.GuidancePreset} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.gooseai.GuidanceParameters} returns this
 */
proto.gooseai.GuidanceParameters.prototype.clearGuidancePreset = function() {
  return jspb.Message.setField(this, 2, undefined);
};
 ...
 * @return {boolean}
 */
proto.gooseai.GuidanceParameters.prototype.hasGuidancePreset = function() {
  return jspb.Message.getField(this, 2) != null;
};
