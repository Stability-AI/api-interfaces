...
goog.exportSymbol('proto.gooseai.UpscaleParameters', null, global);
 ...
 * @constructor
 */
proto.gooseai.UpscaleParameters = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.gooseai.UpscaleParameters, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.gooseai.UpscaleParameters.displayName = 'proto.gooseai.UpscaleParameters';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.gooseai.UpscaleParameters.prototype.toObject = function(opt_includeInstance) {
  return proto.gooseai.UpscaleParameters.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gooseai.UpscaleParameters} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.UpscaleParameters.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.gooseai.UpscaleParameters}
 */
proto.gooseai.UpscaleParameters.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gooseai.UpscaleParameters;
  return proto.gooseai.UpscaleParameters.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gooseai.UpscaleParameters} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gooseai.UpscaleParameters}
 */
proto.gooseai.UpscaleParameters.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.gooseai.UpscaleParameters.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gooseai.UpscaleParameters.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gooseai.UpscaleParameters} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.UpscaleParameters.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getScale();
  if (f !== 0.0) {
    writer.writeFloat(
 ...
 * @return {number}
 */
proto.gooseai.UpscaleParameters.prototype.getScale = function() {
  return /** @type {number} */ (jspb.Message.getFloatingPointFieldWithDefault(this, 1, 0.0));
};
...
/**
 * @param {number} value
 * @return {!proto.gooseai.UpscaleParameters} returns this
 */
proto.gooseai.UpscaleParameters.prototype.setScale = function(value) {
  return jspb.Message.setProto3FloatField(this, 1, value);
};
...
proto.gooseai.Request.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    upscale: (f = msg.getUpscale()) && proto.gooseai.UpscaleParameters.toObject(includeInstance, f),
...
proto.gooseai.Request.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 8:
      ...
      break;
    case 11:
      var value = new proto.gooseai.UpscaleParameters;
      reader.readMessage(value,proto.gooseai.UpscaleParameters.deserializeBinaryFromReader);
      msg.setUpscale(value);
      break;
    case 6:
...
proto.gooseai.Request.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getUpscale();
  if (f != null) {
    writer.writeMessage(
      11,
      f,
      proto.gooseai.UpscaleParameters.serializeBinaryToWriter
    );
  }
  f = message.getConditioner();
  if (f != null) {
...
/**
 * optional UpscaleParameters upscale = 11;
 * @return {?proto.gooseai.UpscaleParameters}
 */
proto.gooseai.Request.prototype.getUpscale = function() {
  return /** @type{?proto.gooseai.UpscaleParameters} */ (
    jspb.Message.getWrapperField(this, proto.gooseai.UpscaleParameters, 11));
};


/**
 * @param {?proto.gooseai.UpscaleParameters|undefined} value
 * @return {!proto.gooseai.Request} returns this
*/
proto.gooseai.Request.prototype.setUpscale = function(value) {
 ...
 * @return {!proto.gooseai.Request} returns this
 */
proto.gooseai.Request.prototype.clearUpscale = function() {
  return this.setUpscale(undefined);
};
 ...
 * @return {boolean}
 */
proto.gooseai.Request.prototype.hasUpscale = function() {
  return jspb.Message.getField(this, 11) != null;
};
