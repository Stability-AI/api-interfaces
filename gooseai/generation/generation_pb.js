...
goog.exportSymbol('proto.gooseai.C2PAParameters', null, global);
goog.exportSymbol('proto.gooseai.C2PAParameters.ModelMetadata', null, global);
goog.exportSymbol('proto.gooseai.C2PAParameters.ParametersCase', null, global);
 ...
 * @constructor
 */
proto.gooseai.C2PAParameters = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.gooseai.C2PAParameters.oneofGroups_);
};
goog.inherits(proto.gooseai.C2PAParameters, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.gooseai.C2PAParameters.displayName = 'proto.gooseai.C2PAParameters';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.gooseai.C2PAParameters.oneofGroups_ = [[1]];

/**
 * @enum {number}
 */
proto.gooseai.C2PAParameters.ParametersCase = {
  PARAMETERS_NOT_SET: 0,
  MODEL_METADATA: 1
};

/**
 * @return {proto.gooseai.C2PAParameters.ParametersCase}
 */
proto.gooseai.C2PAParameters.prototype.getParametersCase = function() {
  return /** @type {proto.gooseai.C2PAParameters.ParametersCase} */(jspb.Message.computeOneofCase(this, proto.gooseai.C2PAParameters.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.gooseai.C2PAParameters.prototype.toObject = function(opt_includeInstance) {
  return proto.gooseai.C2PAParameters.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gooseai.C2PAParameters} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.C2PAParameters.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.gooseai.C2PAParameters}
 */
proto.gooseai.C2PAParameters.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gooseai.C2PAParameters;
  return proto.gooseai.C2PAParameters.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gooseai.C2PAParameters} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gooseai.C2PAParameters}
 */
proto.gooseai.C2PAParameters.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.gooseai.C2PAParameters.ModelMetadata} */ (reader.readEnum());
 ...
 * @return {!Uint8Array}
 */
proto.gooseai.C2PAParameters.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gooseai.C2PAParameters.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gooseai.C2PAParameters} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.C2PAParameters.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = /** @type {!proto.gooseai.C2PAParameters.ModelMetadata} */ (jspb.Message.getField(message, 1));
  if (f != null) {
    writer.writeEnum(
      1,
      f
 ...
 * @enum {number}
 */
proto.gooseai.C2PAParameters.ModelMetadata = {
 ...
 * @return {!proto.gooseai.C2PAParameters.ModelMetadata}
 */
proto.gooseai.C2PAParameters.prototype.getModelMetadata = function() {
  return /** @type {!proto.gooseai.C2PAParameters.ModelMetadata} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.gooseai.C2PAParameters.ModelMetadata} value
 * @return {!proto.gooseai.C2PAParameters} returns this
 */
proto.gooseai.C2PAParameters.prototype.setModelMetadata = function(value) {
  return jspb.Message.setOneofField(this, 1, proto.gooseai.C2PAParameters.oneofGroups_[0], value);
};
 ...
 * @return {!proto.gooseai.C2PAParameters} returns this
 */
proto.gooseai.C2PAParameters.prototype.clearModelMetadata = function() {
  return jspb.Message.setOneofField(this, 1, proto.gooseai.C2PAParameters.oneofGroups_[0], undefined);
};
 ...
 * @return {boolean}
 */
proto.gooseai.C2PAParameters.prototype.hasModelMetadata = function() {
  return jspb.Message.getField(this, 1) != null;
};
...
proto.gooseai.ImageParameters.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    c2paParameters: (f = msg.getC2paParameters()) && proto.gooseai.C2PAParameters.toObject(includeInstance, f)
  };
...
proto.gooseai.ImageParameters.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 13:
      ...
      break;
    case 14:
      var value = new proto.gooseai.C2PAParameters;
      reader.readMessage(value,proto.gooseai.C2PAParameters.deserializeBinaryFromReader);
      msg.setC2paParameters(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.gooseai.ImageParameters.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getC2paParameters();
  if (f != null) {
    writer.writeMessage(
      14,
      f,
      proto.gooseai.C2PAParameters.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional C2PAParameters c2pa_parameters = 14;
 * @return {?proto.gooseai.C2PAParameters}
 */
proto.gooseai.ImageParameters.prototype.getC2paParameters = function() {
  return /** @type{?proto.gooseai.C2PAParameters} */ (
    jspb.Message.getWrapperField(this, proto.gooseai.C2PAParameters, 14));
};


/**
 * @param {?proto.gooseai.C2PAParameters|undefined} value
 * @return {!proto.gooseai.ImageParameters} returns this
*/
proto.gooseai.ImageParameters.prototype.setC2paParameters = function(value) {
 ...
 * @return {!proto.gooseai.ImageParameters} returns this
 */
proto.gooseai.ImageParameters.prototype.clearC2paParameters = function() {
  return this.setC2paParameters(undefined);
};
 ...
 * @return {boolean}
 */
proto.gooseai.ImageParameters.prototype.hasC2paParameters = function() {
  return jspb.Message.getField(this, 14) != null;
};
