...
function serialize_gooseai_Answer(arg) {
  if (!(arg instanceof generation_generation_pb.Answer)) {
...
function deserialize_gooseai_Answer(buffer_arg) {
  return generation_generation_pb.Answer.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_ChainRequest(arg) {
  if (!(arg instanceof generation_generation_pb.ChainRequest)) {
...
function deserialize_gooseai_ChainRequest(buffer_arg) {
  return generation_generation_pb.ChainRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_Request(arg) {
  if (!(arg instanceof generation_generation_pb.Request)) {
...
function deserialize_gooseai_Request(buffer_arg) {
  return generation_generation_pb.Request.deserializeBinary(new Uint8Array(buffer_arg));
}
