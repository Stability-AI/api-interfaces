...
type Artifact struct {
	...
	Uuid         []byte          `protobuf:"bytes,12,opt,name=uuid,proto3" json:"uuid,omitempty"`                                                               // UUIDv4 of the artifact, used for asset lookup
...
func (x *AssetParameters) GetProjectId() []byte {
	if x != nil {
		return x.ProjectId
	}
	return nil
...
var file_generation_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x75, 0x75, 0x69, 0x64, 0x12, 0x12,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x12,
