...
type EstimateCostResponse struct {
	...
	CreditCost float64 `protobuf:"fixed64,1,opt,name=credit_cost,json=creditCost,proto3" json:"credit_cost,omitempty"`
}
...
func (x *EstimateCostResponse) GetCreditCost() float64 {
	if x != nil {
		return x.CreditCost
	}
	return 0
...
var file_generation_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x65, 0x72, 0x22, 0x37, 0x0a, 0x14, 0x45, 0x73, 0x74, 0x69, 0x6d, 0x61, 0x74,
	0x65, 0x43, 0x6f, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1f, 0x0a,
	0x0b, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x5f, 0x63, 0x6f, 0x73, 0x74, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x01, 0x52, 0x0a, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x43, 0x6f, 0x73, 0x74, 0x22, 0x8f,
	...
	0x04, 0x2a, 0xba, 0x01, 0x0a, 0x0c, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x54, 0x79,
	...
	0x52, 0x54, 0x49, 0x46, 0x41, 0x43, 0x54, 0x5f, 0x4d, 0x41, 0x53, 0x4b, 0x10, 0x07, 0x2a, 0xc5,
	...
	0x5f, 0x4c, 0x4d, 0x53, 0x10, 0x07, 0x2a, 0x46, 0x0a, 0x08, 0x55, 0x70, 0x73, 0x63, 0x61, 0x6c,
	...
	0x52, 0x4e, 0x10, 0x02, 0x32, 0xc6, 0x01, 0x0a, 0x11, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74,
	...
	0x41, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x22, 0x00, 0x30, 0x01, 0x12, 0x41, 0x0a, 0x0c, 0x45, 0x73,
	0x74, 0x69, 0x6d, 0x61, 0x74, 0x65, 0x43, 0x6f, 0x73, 0x74, 0x12, 0x10, 0x2e, 0x67, 0x6f, 0x6f,
	0x73, 0x65, 0x61, 0x69, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1d, 0x2e, 0x67,
	0x6f, 0x6f, 0x73, 0x65, 0x61, 0x69, 0x2e, 0x45, 0x73, 0x74, 0x69, 0x6d, 0x61, 0x74, 0x65, 0x43,
...
var file_generation_proto_goTypes = []interface{}{
	...
	(*EstimateCostResponse)(nil),       // 34: gooseai.EstimateCostResponse
...
var file_generation_proto_depIdxs = []int32{
	...
	35, // 43: gooseai.Stage.on_status:type_name -> gooseai.OnStatus
	36, // 44: gooseai.ChainRequest.stage:type_name -> gooseai.Stage
	33, // 45: gooseai.GenerationService.Generate:input_type -> gooseai.Request
	37, // 46: gooseai.GenerationService.ChainGenerate:input_type -> gooseai.ChainRequest
	33, // 47: gooseai.GenerationService.EstimateCost:input_type -> gooseai.Request
	...
	34, // 50: gooseai.GenerationService.EstimateCost:output_type -> gooseai.EstimateCostResponse
