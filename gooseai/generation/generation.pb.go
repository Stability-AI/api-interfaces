...
var file_generation_proto_rawDesc = []byte{
	...
	0x6c, 0x69, 0x7a, 0x65, 0x64, 0x5f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x80, 0x03, 0x0a,
	...
	0x48, 0x00, 0x52, 0x0a, 0x63, 0x6c, 0x61, 0x73, 0x73, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x45,
	...
	0x4c, 0x54, 0x49, 0x43, 0x4c, 0x41, 0x53, 0x53, 0x10, 0x01, 0x2a, 0x57, 0x0a, 0x0b, 0x53, 0x74,
...
var file_generation_proto_enumTypes = make([]protoimpl.EnumInfo, 7)
var file_generation_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_generation_proto_goTypes = []interface{}{
	...
	(StageAction)(0),              // 6: gooseai.StageAction
	(*Token)(nil),                 // 7: gooseai.Token
	(*Tokens)(nil),                // 8: gooseai.Tokens
	(*Artifact)(nil),              // 9: gooseai.Artifact
	(*PromptParameters)(nil),      // 10: gooseai.PromptParameters
	(*Prompt)(nil),                // 11: gooseai.Prompt
	(*AnswerMeta)(nil),            // 12: gooseai.AnswerMeta
	(*Answer)(nil),                // 13: gooseai.Answer
	(*SamplerParameters)(nil),     // 14: gooseai.SamplerParameters
	(*ConditionerParameters)(nil), // 15: gooseai.ConditionerParameters
	(*ScheduleParameters)(nil),    // 16: gooseai.ScheduleParameters
	(*StepParameter)(nil),         // 17: gooseai.StepParameter
	(*TransformType)(nil),         // 18: gooseai.TransformType
	(*ImageParameters)(nil),       // 19: gooseai.ImageParameters
	(*ClassifierConcept)(nil),     // 20: gooseai.ClassifierConcept
	(*ClassifierCategory)(nil),    // 21: gooseai.ClassifierCategory
	(*ClassifierParameters)(nil),  // 22: gooseai.ClassifierParameters
	(*Request)(nil),               // 23: gooseai.Request
	(*OnStatus)(nil),              // 24: gooseai.OnStatus
	(*Stage)(nil),                 // 25: gooseai.Stage
	(*ChainRequest)(nil),          // 26: gooseai.ChainRequest
}
var file_generation_proto_depIdxs = []int32{
	7,  // 0: gooseai.Tokens.tokens:type_name -> gooseai.Token
	1,  // 1: gooseai.Artifact.type:type_name -> gooseai.ArtifactType
	8,  // 2: gooseai.Artifact.tokens:type_name -> gooseai.Tokens
	22, // 3: gooseai.Artifact.classifier:type_name -> gooseai.ClassifierParameters
	0,  // 4: gooseai.Artifact.finish_reason:type_name -> gooseai.FinishReason
	10, // 5: gooseai.Prompt.parameters:type_name -> gooseai.PromptParameters
	8,  // 6: gooseai.Prompt.tokens:type_name -> gooseai.Tokens
	9,  // 7: gooseai.Prompt.artifact:type_name -> gooseai.Artifact
	12, // 8: gooseai.Answer.meta:type_name -> gooseai.AnswerMeta
	9,  // 9: gooseai.Answer.artifacts:type_name -> gooseai.Artifact
	14, // 10: gooseai.StepParameter.sampler:type_name -> gooseai.SamplerParameters
	16, // 11: gooseai.StepParameter.schedule:type_name -> gooseai.ScheduleParameters
	...
	18, // 14: gooseai.ImageParameters.transform:type_name -> gooseai.TransformType
	17, // 15: gooseai.ImageParameters.parameters:type_name -> gooseai.StepParameter
	20, // 16: gooseai.ClassifierCategory.concepts:type_name -> gooseai.ClassifierConcept
	...
	21, // 19: gooseai.ClassifierParameters.categories:type_name -> gooseai.ClassifierCategory
	21, // 20: gooseai.ClassifierParameters.exceeds:type_name -> gooseai.ClassifierCategory
	4,  // 21: gooseai.ClassifierParameters.realized_action:type_name -> gooseai.Action
	1,  // 22: gooseai.Request.requested_type:type_name -> gooseai.ArtifactType
	11, // 23: gooseai.Request.prompt:type_name -> gooseai.Prompt
	19, // 24: gooseai.Request.image:type_name -> gooseai.ImageParameters
	22, // 25: gooseai.Request.classifier:type_name -> gooseai.ClassifierParameters
	15, // 26: gooseai.Request.conditioner:type_name -> gooseai.ConditionerParameters
	0,  // 27: gooseai.OnStatus.reason:type_name -> gooseai.FinishReason
	6,  // 28: gooseai.OnStatus.action:type_name -> gooseai.StageAction
	23, // 29: gooseai.Stage.request:type_name -> gooseai.Request
	24, // 30: gooseai.Stage.on_status:type_name -> gooseai.OnStatus
	25, // 31: gooseai.ChainRequest.stage:type_name -> gooseai.Stage
	23, // 32: gooseai.GenerationService.Generate:input_type -> gooseai.Request
	26, // 33: gooseai.GenerationService.ChainGenerate:input_type -> gooseai.ChainRequest
	13, // 34: gooseai.GenerationService.Generate:output_type -> gooseai.Answer
	13, // 35: gooseai.GenerationService.ChainGenerate:output_type -> gooseai.Answer
