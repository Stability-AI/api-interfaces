...
var file_generation_proto_rawDesc = []byte{
	...
	0x66, 0x61, 0x63, 0x74, 0x73, 0x42, 0x07, 0x0a, 0x05, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x22, 0xb3,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x88, 0x01, 0x01, 0x12, 0x3f, 0x0a, 0x0d, 0x77, 0x65, 0x69,
	...
	,
	...
	0x49, 0x46, 0x41, 0x43, 0x54, 0x5f, 0x54, 0x45, 0x4e, 0x53, 0x4f, 0x52, 0x10, 0x09, 0x2a, 0x35,
	...
	0x49, 0x4f, 0x4e, 0x10, 0x01, 0x2a, 0xff, 0x01, 0x0a, 0x10, 0x44, 0x69, 0x66, 0x66, 0x75, 0x73,
	...
	0x50, 0x50, 0x5f, 0x32, 0x4d, 0x10, 0x09, 0x2a, 0x46, 0x0a, 0x08, 0x55, 0x70, 0x73, 0x63, 0x61,
...
var file_generation_proto_goTypes = []interface{}{
	...
	(AssetAction)(0),                   // 9: gooseai.AssetAction
	(AssetUse)(0),                      // 10: gooseai.AssetUse
	...
	(*tensors.Tensor)(nil),             // 38: tensors.Tensor
}
var file_generation_proto_depIdxs = []int32{
	...
	38, // 4: gooseai.Artifact.tensor:type_name -> tensors.Tensor
	0,  // 5: gooseai.Artifact.finish_reason:type_name -> gooseai.FinishReason
	15, // 6: gooseai.Prompt.parameters:type_name -> gooseai.PromptParameters
	13, // 7: gooseai.Prompt.tokens:type_name -> gooseai.Tokens
	14, // 8: gooseai.Prompt.artifact:type_name -> gooseai.Artifact
	21, // 9: gooseai.ConditionerParameters.conditioner:type_name -> gooseai.Model
	17, // 10: gooseai.StepParameter.sampler:type_name -> gooseai.SamplerParameters
	19, // 11: gooseai.StepParameter.schedule:type_name -> gooseai.ScheduleParameters
	25, // 12: gooseai.StepParameter.guidance:type_name -> gooseai.GuidanceParameters
	6,  // 13: gooseai.Model.architecture:type_name -> gooseai.ModelArchitecture
	22, // 14: gooseai.CutoutParameters.cutouts:type_name -> gooseai.CutoutParameters
	21, // 15: gooseai.GuidanceInstanceParameters.models:type_name -> gooseai.Model
	23, // 16: gooseai.GuidanceInstanceParameters.schedule:type_name -> gooseai.GuidanceScheduleParameters
	22, // 17: gooseai.GuidanceInstanceParameters.cutouts:type_name -> gooseai.CutoutParameters
	16, // 18: gooseai.GuidanceInstanceParameters.prompt:type_name -> gooseai.Prompt
	5,  // 19: gooseai.GuidanceParameters.guidance_preset:type_name -> gooseai.GuidancePreset
	24, // 20: gooseai.GuidanceParameters.instances:type_name -> gooseai.GuidanceInstanceParameters
	...
	7,  // 26: gooseai.ClassifierCategory.action:type_name -> gooseai.Action
	8,  // 27: gooseai.ClassifierCategory.classifier_mode:type_name -> gooseai.ClassifierMode
	...
	7,  // 30: gooseai.ClassifierParameters.realized_action:type_name -> gooseai.Action
	9,  // 31: gooseai.AssetParameters.action:type_name -> gooseai.AssetAction
	10, // 32: gooseai.AssetParameters.use:type_name -> gooseai.AssetUse
	32, // 33: gooseai.Answer.meta:type_name -> gooseai.AnswerMeta
	14, // 34: gooseai.Answer.artifacts:type_name -> gooseai.Artifact
	1,  // 35: gooseai.Request.requested_type:type_name -> gooseai.ArtifactType
	16, // 36: gooseai.Request.prompt:type_name -> gooseai.Prompt
	27, // 37: gooseai.Request.image:type_name -> gooseai.ImageParameters
	30, // 38: gooseai.Request.classifier:type_name -> gooseai.ClassifierParameters
	31, // 39: gooseai.Request.asset:type_name -> gooseai.AssetParameters
	18, // 40: gooseai.Request.conditioner:type_name -> gooseai.ConditionerParameters
	2,  // 41: gooseai.Request.weight_method:type_name -> gooseai.WeightMethod
	16, // 42: gooseai.Request.uc_prompt:type_name -> gooseai.Prompt
	0,  // 43: gooseai.OnStatus.reason:type_name -> gooseai.FinishReason
	11, // 44: gooseai.OnStatus.action:type_name -> gooseai.StageAction
	34, // 45: gooseai.Stage.request:type_name -> gooseai.Request
	35, // 46: gooseai.Stage.on_status:type_name -> gooseai.OnStatus
	36, // 47: gooseai.ChainRequest.stage:type_name -> gooseai.Stage
	34, // 48: gooseai.GenerationService.Generate:input_type -> gooseai.Request
	37, // 49: gooseai.GenerationService.ChainGenerate:input_type -> gooseai.ChainRequest
	33, // 50: gooseai.GenerationService.Generate:output_type -> gooseai.Answer
	33, // 51: gooseai.GenerationService.ChainGenerate:output_type -> gooseai.Answer
