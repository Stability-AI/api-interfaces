...
var file_generation_proto_rawDesc = []byte{
	...
	0x76, 0x0a, 0x0f, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x70, 0x6f, 0x6c, 0x61, 0x74, 0x65, 0x4d, 0x6f,
	...
	0x53, 0x4c, 0x45, 0x52, 0x50, 0x10, 0x03, 0x2a, 0x6c, 0x0a, 0x0a, 0x42, 0x6f, 0x72, 0x64, 0x65,
	...
	0x48, 0x49, 0x43, 0x10, 0x01, 0x2a, 0x3d, 0x0a, 0x0b, 0x41, 0x73, 0x73, 0x65, 0x74, 0x41, 0x63,
...
var file_generation_proto_depIdxs = []int32{
	...
	21, // 55: gooseai.Request.prompt:type_name -> gooseai.Prompt
	32, // 56: gooseai.Request.image:type_name -> gooseai.ImageParameters
	35, // 57: gooseai.Request.classifier:type_name -> gooseai.ClassifierParameters
	47, // 58: gooseai.Request.asset:type_name -> gooseai.AssetParameters
	36, // 59: gooseai.Request.interpolate:type_name -> gooseai.InterpolateParameters
	46, // 60: gooseai.Request.transform:type_name -> gooseai.TransformParameters
	23, // 61: gooseai.Request.conditioner:type_name -> gooseai.ConditionerParameters
	55, // 62: gooseai.Request.extras:type_name -> google.protobuf.Struct
	0,  // 63: gooseai.OnStatus.reason:type_name -> gooseai.FinishReason
	16, // 64: gooseai.OnStatus.action:type_name -> gooseai.StageAction
	50, // 65: gooseai.Stage.request:type_name -> gooseai.Request
	51, // 66: gooseai.Stage.on_status:type_name -> gooseai.OnStatus
	52, // 67: gooseai.ChainRequest.stage:type_name -> gooseai.Stage
	50, // 68: gooseai.GenerationService.Generate:input_type -> gooseai.Request
	53, // 69: gooseai.GenerationService.ChainGenerate:input_type -> gooseai.ChainRequest
