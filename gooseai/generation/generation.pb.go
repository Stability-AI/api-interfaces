...
// Currently the server will reject batches of more than 1 chain request.
// This is still useful to enable unary responses via BatchGenerate.
type BatchRequest struct {
	...
	BatchId  string          `protobuf:"bytes,1,opt,name=batch_id,json=batchId,proto3" json:"batch_id,omitempty"`
	Requests []*ChainRequest `protobuf:"bytes,2,rep,name=requests,proto3" json:"requests,omitempty"`
}
...
func (x *BatchRequest) GetRequests() []*ChainRequest {
	if x != nil {
		return x.Requests
	}
	return nil
...
var file_generation_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x67, 0x65, 0x22, 0x5c, 0x0a, 0x0c, 0x42, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x62, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x69,
	...
	0x28, 0x0b, 0x32, 0x15, 0x2e, 0x67, 0x6f, 0x6f, 0x73, 0x65, 0x61, 0x69, 0x2e, 0x43, 0x68, 0x61,
	0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x08, 0x72, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x73, 0x2a, 0x45, 0x0a, 0x0c, 0x46, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x52, 0x65, 0x61,
	...
	0x4f, 0x4e, 0x5f, 0x52, 0x45, 0x54, 0x55, 0x52, 0x4e, 0x10, 0x02, 0x32, 0xc3, 0x01, 0x0a, 0x11,
	...
	0x01, 0x12, 0x3e, 0x0a, 0x0d, 0x42, 0x61, 0x74, 0x63, 0x68, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61,
	0x74, 0x65, 0x12, 0x15, 0x2e, 0x67, 0x6f, 0x6f, 0x73, 0x65, 0x61, 0x69, 0x2e, 0x42, 0x61, 0x74,
	0x63, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x67, 0x6f, 0x6f, 0x73,
	0x65, 0x61, 0x69, 0x2e, 0x41, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x42, 0x61, 0x74, 0x63, 0x68, 0x22,
...
var file_generation_proto_goTypes = []interface{}{
	...
	(*BatchRequest)(nil),               // 55: gooseai.BatchRequest
...
var file_generation_proto_depIdxs = []int32{
	...
	54, // 69: gooseai.BatchRequest.requests:type_name -> gooseai.ChainRequest
	51, // 70: gooseai.GenerationService.Generate:input_type -> gooseai.Request
	54, // 71: gooseai.GenerationService.ChainGenerate:input_type -> gooseai.ChainRequest
	55, // 72: gooseai.GenerationService.BatchGenerate:input_type -> gooseai.BatchRequest
	49, // 73: gooseai.GenerationService.Generate:output_type -> gooseai.Answer
	49, // 74: gooseai.GenerationService.ChainGenerate:output_type -> gooseai.Answer
	50, // 75: gooseai.GenerationService.BatchGenerate:output_type -> gooseai.AnswerBatch
