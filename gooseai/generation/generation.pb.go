...
const (
	CameraType_CAMERA_PERSPECTIVE  CameraType = 0
	CameraType_CAMERA_ORTHOGRAPHIC CameraType = 1
)
...
//   - Init Depth (singular, optional, Artifact type ARTIFACT_DEPTH)
type Prompt struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
type PointCloudRenderSettings struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PointCloudRenderSettings) Reset() {
	*x = PointCloudRenderSettings{}
	if protoimpl.UnsafeEnabled {
...
func (x *PointCloudRenderSettings) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PointCloudRenderSettings) ProtoMessage() {}

func (x *PointCloudRenderSettings) ProtoReflect() protoreflect.Message {
	mi := &file_generation_proto_msgTypes[26]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PointCloudRenderSettings.ProtoReflect.Descriptor instead.
func (*PointCloudRenderSettings) Descriptor() ([]byte, []int) {
	return file_generation_proto_rawDescGZIP(), []int{26}
}

func (x *PointCloudRenderSettings) GetRadius() float32 {
	if x != nil {
		return x.Radius
	}
	return 0
...
func (x *PointCloudRenderSettings) GetPointsPerPixel() uint32 {
	if x != nil {
...
type MeshRenderSettings struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	MaxMeshEdge float32 `protobuf:"fixed32,1,opt,name=max_mesh_edge,json=maxMeshEdge,proto3" json:"max_mesh_edge,omitempty"`
}

func (x *MeshRenderSettings) Reset() {
	*x = MeshRenderSettings{}
	if protoimpl.UnsafeEnabled {
...
func (x *MeshRenderSettings) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MeshRenderSettings) ProtoMessage() {}

func (x *MeshRenderSettings) ProtoReflect() protoreflect.Message {
	mi := &file_generation_proto_msgTypes[27]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MeshRenderSettings.ProtoReflect.Descriptor instead.
func (*MeshRenderSettings) Descriptor() ([]byte, []int) {
	return file_generation_proto_rawDescGZIP(), []int{27}
}

func (x *MeshRenderSettings) GetMaxMeshEdge() float32 {
	if x != nil {
...
type RenderSettings struct {
	...
	// Types that are assignable to RenderSettings:
	//
	//	*RenderSettings_PointcloudSettings
	//	*RenderSettings_MeshSettings
	RenderSettings isRenderSettings_RenderSettings `protobuf_oneof:"render_settings"`
}
...
func (m *RenderSettings) GetRenderSettings() isRenderSettings_RenderSettings {
	if m != nil {
...
func (x *RenderSettings) GetPointcloudSettings() *PointCloudRenderSettings {
	if x, ok := x.GetRenderSettings().(*RenderSettings_PointcloudSettings); ok {
		return x.PointcloudSettings
	}
	return nil
}

func (x *RenderSettings) GetMeshSettings() *MeshRenderSettings {
	if x, ok := x.GetRenderSettings().(*RenderSettings_MeshSettings); ok {
		return x.MeshSettings
	}
	return nil
}

type isRenderSettings_RenderSettings interface {
	isRenderSettings_RenderSettings()
}

type RenderSettings_PointcloudSettings struct {
	PointcloudSettings *PointCloudRenderSettings `protobuf:"bytes,1,opt,name=pointcloud_settings,json=pointcloudSettings,proto3,oneof"`
}

type RenderSettings_MeshSettings struct {
	MeshSettings *MeshRenderSettings `protobuf:"bytes,2,opt,name=mesh_settings,json=meshSettings,proto3,oneof"`
}

func (*RenderSettings_PointcloudSettings) isRenderSettings_RenderSettings() {}

func (*RenderSettings_MeshSettings) isRenderSettings_RenderSettings() {}
...
type CameraSettings struct {
	...
	NearPlane float32  `protobuf:"fixed32,1,opt,name=near_plane,json=nearPlane,proto3" json:"near_plane,omitempty"`
	FarPlane  float32  `protobuf:"fixed32,2,opt,name=far_plane,json=farPlane,proto3" json:"far_plane,omitempty"`
	Fov       *float32 `protobuf:"fixed32,3,opt,name=fov,proto3,oneof" json:"fov,omitempty"` // Camera field of view (in angles). Must be set for CAMERA_PERSPECTIVE type.
}
...
func (x *CameraSettings) GetNearPlane() float32 {
	if x != nil {
		return x.NearPlane
	}
	return 0
...
func (x *CameraSettings) GetFarPlane() float32 {
	if x != nil {
		return x.FarPlane
	}
	return 0
...
func (x *CameraSettings) GetFov() float32 {
	if x != nil && x.Fov != nil {
		return *x.Fov
	}
	return 0
...
type TransformCameraPose struct {
	...
	WorldToViewMatrix   *TransformMatrix `protobuf:"bytes,1,opt,name=world_to_view_matrix,json=worldToViewMatrix,proto3" json:"world_to_view_matrix,omitempty"`
	CameraSettings      *CameraSettings  `protobuf:"bytes,2,opt,name=camera_settings,json=cameraSettings,proto3" json:"camera_settings,omitempty"`
	CameraType          CameraType       `protobuf:"varint,3,opt,name=camera_type,json=cameraType,proto3,enum=gooseai.CameraType" json:"camera_type,omitempty"`
	ImageRenderSettings *RenderSettings  `protobuf:"bytes,4,opt,name=image_render_settings,json=imageRenderSettings,proto3" json:"image_render_settings,omitempty"`
	MaskRenderSettings  *RenderSettings  `protobuf:"bytes,5,opt,name=mask_render_settings,json=maskRenderSettings,proto3" json:"mask_render_settings,omitempty"`
	DoPrefill           bool             `protobuf:"varint,6,opt,name=do_prefill,json=doPrefill,proto3" json:"do_prefill,omitempty"`
}
...
func (x *TransformCameraPose) GetCameraSettings() *CameraSettings {
	if x != nil {
		return x.CameraSettings
	}
	return nil
}

func (x *TransformCameraPose) GetCameraType() CameraType {
	if x != nil {
		return x.CameraType
	}
...
func (x *TransformCameraPose) GetImageRenderSettings() *RenderSettings {
	if x != nil {
		return x.ImageRenderSettings
	}
	return nil
}

func (x *TransformCameraPose) GetMaskRenderSettings() *RenderSettings {
	if x != nil {
		return x.MaskRenderSettings
	}
	return nil
}
...
var file_generation_proto_rawDesc = []byte{
	...
	0x42, 0x07, 0x0a, 0x05, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x22, 0x53, 0x0a, 0x0e, 0x54, 0x72, 0x61,
	...
	0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x52, 0x06, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x22, 0xfc,
	0x01, 0x0a, 0x14, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x6f, 0x72, 0x6d, 0x43, 0x6f, 0x6c, 0x6f,
	...
	0x6c, 0x69, 0x67, 0x68, 0x74, 0x6e, 0x65, 0x73, 0x73, 0x88, 0x01, 0x01, 0x42, 0x0d, 0x0a, 0x0b,
	...
	0x0c, 0x0a, 0x0a, 0x5f, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x6e, 0x65, 0x73, 0x73, 0x22, 0x76, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	0x38, 0x0a, 0x08, 0x72, 0x65, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x73, 0x65, 0x61, 0x69, 0x2e, 0x54, 0x72, 0x61, 0x6e,
	0x73, 0x66, 0x6f, 0x72, 0x6d, 0x52, 0x65, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x48, 0x00, 0x52,
	0x08, 0x72, 0x65, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x12, 0x3f, 0x0a, 0x0b, 0x63, 0x61, 0x6d,
	0x65, 0x72, 0x61, 0x5f, 0x70, 0x6f, 0x73, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c,
	...
	0x61, 0x6e, 0x73, 0x66, 0x6f, 0x72, 0x6d, 0x22, 0x83, 0x01, 0x0a, 0x0f, 0x41, 0x73, 0x73, 0x65,
	...
	0x42, 0x07, 0x0a, 0x05, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x22, 0x82, 0x05, 0x0a, 0x07, 0x52, 0x65,
	...
	0x74, 0x65, 0x72, 0x73, 0x48, 0x00, 0x52, 0x05, 0x61, 0x73, 0x73, 0x65, 0x74, 0x12, 0x42, 0x0a,
	0x0b, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x70, 0x6f, 0x6c, 0x61, 0x74, 0x65, 0x18, 0x0b, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x67, 0x6f, 0x6f, 0x73, 0x65, 0x61, 0x69, 0x2e, 0x49, 0x6e, 0x74,
	0x65, 0x72, 0x70, 0x6f, 0x6c, 0x61, 0x74, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65,
	0x72, 0x73, 0x48, 0x00, 0x52, 0x0b, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x70, 0x6f, 0x6c, 0x61, 0x74,
	0x65, 0x12, 0x3c, 0x0a, 0x09, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x6f, 0x72, 0x6d, 0x18, 0x0c,
	...
	,
	...
	0x73, 0x74, 0x49, 0x64, 0x12, 0x24, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x67, 0x65, 0x18, 0x02, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x67, 0x6f, 0x6f, 0x73, 0x65, 0x61, 0x69, 0x2e, 0x53, 0x74,
	0x61, 0x67, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x67, 0x65, 0x2a, 0x45, 0x0a, 0x0c, 0x46, 0x69,
	...
	0x52, 0x4f, 0x52, 0x10, 0x03, 0x12, 0x0a, 0x0a, 0x06, 0x46, 0x49, 0x4c, 0x54, 0x45, 0x52, 0x10,
	0x04, 0x2a, 0xf8, 0x01, 0x0a, 0x0c, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x54, 0x79,
	...
	,
	...
	0x4d, 0x53, 0x10, 0x07, 0x12, 0x20, 0x0a, 0x1c, 0x53, 0x41, 0x4d, 0x50, 0x4c, 0x45, 0x52, 0x5f,
	0x4b, 0x5f, 0x44, 0x50, 0x4d, 0x50, 0x50, 0x5f, 0x32, 0x53, 0x5f, 0x41, 0x4e, 0x43, 0x45, 0x53,
	0x54, 0x52, 0x41, 0x4c, 0x10, 0x08, 0x12, 0x16, 0x0a, 0x12, 0x53, 0x41, 0x4d, 0x50, 0x4c, 0x45,
	0x52, 0x5f, 0x4b, 0x5f, 0x44, 0x50, 0x4d, 0x50, 0x50, 0x5f, 0x32, 0x4d, 0x10, 0x09, 0x12, 0x17,
	0x0a, 0x13, 0x53, 0x41, 0x4d, 0x50, 0x4c, 0x45, 0x52, 0x5f, 0x4b, 0x5f, 0x44, 0x50, 0x4d, 0x50,
	0x50, 0x5f, 0x53, 0x44, 0x45, 0x10, 0x0a, 0x2a, 0x46, 0x0a, 0x08, 0x55, 0x70, 0x73, 0x63, 0x61,
	...
	0x54, 0x49, 0x43, 0x4c, 0x41, 0x53, 0x53, 0x10, 0x01, 0x2a, 0x76, 0x0a, 0x0f, 0x49, 0x6e, 0x74,
	...
	0x03, 0x2a, 0x58, 0x0a, 0x0a, 0x42, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x4d, 0x6f, 0x64, 0x65, 0x12,
	0x12, 0x0a, 0x0e, 0x42, 0x4f, 0x52, 0x44, 0x45, 0x52, 0x5f, 0x52, 0x45, 0x46, 0x4c, 0x45, 0x43,
	0x54, 0x10, 0x00, 0x12, 0x14, 0x0a, 0x10, 0x42, 0x4f, 0x52, 0x44, 0x45, 0x52, 0x5f, 0x52, 0x45,
	0x50, 0x4c, 0x49, 0x43, 0x41, 0x54, 0x45, 0x10, 0x01, 0x12, 0x0f, 0x0a, 0x0b, 0x42, 0x4f, 0x52,
	0x44, 0x45, 0x52, 0x5f, 0x57, 0x52, 0x41, 0x50, 0x10, 0x02, 0x12, 0x0f, 0x0a, 0x0b, 0x42, 0x4f,
	0x52, 0x44, 0x45, 0x52, 0x5f, 0x5a, 0x45, 0x52, 0x4f, 0x10, 0x03, 0x2a, 0x4f, 0x0a, 0x0e, 0x43,
	...
	0x48, 0x4f, 0x47, 0x52, 0x41, 0x50, 0x48, 0x49, 0x43, 0x10, 0x01, 0x2a, 0x3d, 0x0a, 0x0b, 0x41,
...
var file_generation_proto_goTypes = []interface{}{
	...
	(*TransformColorAdjust)(nil),       // 38: gooseai.TransformColorAdjust
	(*TransformColorMatch)(nil),        // 39: gooseai.TransformColorMatch
	(*TransformDepthCalc)(nil),         // 40: gooseai.TransformDepthCalc
	(*TransformMatrix)(nil),            // 41: gooseai.TransformMatrix
	(*TransformResample)(nil),          // 42: gooseai.TransformResample
	(*PointCloudRenderSettings)(nil),   // 43: gooseai.PointCloudRenderSettings
	(*MeshRenderSettings)(nil),         // 44: gooseai.MeshRenderSettings
	(*RenderSettings)(nil),             // 45: gooseai.RenderSettings
	(*CameraSettings)(nil),             // 46: gooseai.CameraSettings
...
var file_generation_proto_depIdxs = []int32{
	...
	19, // 34: gooseai.TransformBlend.target:type_name -> gooseai.Artifact
	12, // 35: gooseai.TransformColorMatch.color_mode:type_name -> gooseai.ColorMatchMode
	19, // 36: gooseai.TransformColorMatch.image:type_name -> gooseai.Artifact
	11, // 37: gooseai.TransformResample.border_mode:type_name -> gooseai.BorderMode
	41, // 38: gooseai.TransformResample.transform:type_name -> gooseai.TransformMatrix
	41, // 39: gooseai.TransformResample.prev_transform:type_name -> gooseai.TransformMatrix
	43, // 40: gooseai.RenderSettings.pointcloud_settings:type_name -> gooseai.PointCloudRenderSettings
	44, // 41: gooseai.RenderSettings.mesh_settings:type_name -> gooseai.MeshRenderSettings
	41, // 42: gooseai.TransformCameraPose.world_to_view_matrix:type_name -> gooseai.TransformMatrix
	46, // 43: gooseai.TransformCameraPose.camera_settings:type_name -> gooseai.CameraSettings
	13, // 44: gooseai.TransformCameraPose.camera_type:type_name -> gooseai.CameraType
	45, // 45: gooseai.TransformCameraPose.image_render_settings:type_name -> gooseai.RenderSettings
	45, // 46: gooseai.TransformCameraPose.mask_render_settings:type_name -> gooseai.RenderSettings
	37, // 47: gooseai.TransformParameters.blend:type_name -> gooseai.TransformBlend
	38, // 48: gooseai.TransformParameters.color_adjust:type_name -> gooseai.TransformColorAdjust
	39, // 49: gooseai.TransformParameters.color_match:type_name -> gooseai.TransformColorMatch
	40, // 50: gooseai.TransformParameters.depth_calc:type_name -> gooseai.TransformDepthCalc
	42, // 51: gooseai.TransformParameters.resample:type_name -> gooseai.TransformResample
	47, // 52: gooseai.TransformParameters.camera_pose:type_name -> gooseai.TransformCameraPose
	14, // 53: gooseai.AssetParameters.action:type_name -> gooseai.AssetAction
	15, // 54: gooseai.AssetParameters.use:type_name -> gooseai.AssetUse
	50, // 55: gooseai.Answer.meta:type_name -> gooseai.AnswerMeta
	19, // 56: gooseai.Answer.artifacts:type_name -> gooseai.Artifact
	1,  // 57: gooseai.Request.requested_type:type_name -> gooseai.ArtifactType
	21, // 58: gooseai.Request.prompt:type_name -> gooseai.Prompt
	32, // 59: gooseai.Request.image:type_name -> gooseai.ImageParameters
	35, // 60: gooseai.Request.classifier:type_name -> gooseai.ClassifierParameters
	49, // 61: gooseai.Request.asset:type_name -> gooseai.AssetParameters
	36, // 62: gooseai.Request.interpolate:type_name -> gooseai.InterpolateParameters
	48, // 63: gooseai.Request.transform:type_name -> gooseai.TransformParameters
	23, // 64: gooseai.Request.conditioner:type_name -> gooseai.ConditionerParameters
	57, // 65: gooseai.Request.extras:type_name -> google.protobuf.Struct
	0,  // 66: gooseai.OnStatus.reason:type_name -> gooseai.FinishReason
	16, // 67: gooseai.OnStatus.action:type_name -> gooseai.StageAction
	52, // 68: gooseai.Stage.request:type_name -> gooseai.Request
	53, // 69: gooseai.Stage.on_status:type_name -> gooseai.OnStatus
	54, // 70: gooseai.ChainRequest.stage:type_name -> gooseai.Stage
	52, // 71: gooseai.GenerationService.Generate:input_type -> gooseai.Request
	55, // 72: gooseai.GenerationService.ChainGenerate:input_type -> gooseai.ChainRequest
	51, // 73: gooseai.GenerationService.Generate:output_type -> gooseai.Answer
	51, // 74: gooseai.GenerationService.ChainGenerate:output_type -> gooseai.Answer
...
func file_generation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_generation_proto_msgTypes[26].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PointCloudRenderSettings); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_generation_proto_msgTypes[27].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MeshRenderSettings); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_generation_proto_msgTypes[28].OneofWrappers = []interface{}{
		(*RenderSettings_PointcloudSettings)(nil),
		(*RenderSettings_MeshSettings)(nil),
	}
	...
	file_generation_proto_msgTypes[36].OneofWrappers = []interface{}{}
	type x struct{}
