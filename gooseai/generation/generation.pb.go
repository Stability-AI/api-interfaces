...
var file_generation_proto_rawDesc = []byte{
	...
	0x72, 0x74, 0x5f, 0x6d, 0x61, 0x73, 0x6b, 0x22, 0xd0, 0x02, 0x0a, 0x13, 0x54, 0x72, 0x61, 0x6e,
	...
	0x65, 0x48, 0x00, 0x52, 0x08, 0x72, 0x65, 0x73, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x42, 0x0b, 0x0a,
...
var file_generation_proto_goTypes = []interface{}{
	...
	(*AnswerBatch)(nil),                // 46: gooseai.AnswerBatch
...
var file_generation_proto_depIdxs = []int32{
	...
	45, // 49: gooseai.AnswerBatch.answers:type_name -> gooseai.Answer
	1,  // 50: gooseai.Request.requested_type:type_name -> gooseai.ArtifactType
	20, // 51: gooseai.Request.prompt:type_name -> gooseai.Prompt
	31, // 52: gooseai.Request.image:type_name -> gooseai.ImageParameters
	34, // 53: gooseai.Request.classifier:type_name -> gooseai.ClassifierParameters
	43, // 54: gooseai.Request.asset:type_name -> gooseai.AssetParameters
	35, // 55: gooseai.Request.interpolate:type_name -> gooseai.InterpolateParameters
	42, // 56: gooseai.Request.transform:type_name -> gooseai.TransformParameters
	22, // 57: gooseai.Request.conditioner:type_name -> gooseai.ConditionerParameters
	52, // 58: gooseai.Request.extras:type_name -> google.protobuf.Struct
	0,  // 59: gooseai.OnStatus.reason:type_name -> gooseai.FinishReason
	15, // 60: gooseai.OnStatus.action:type_name -> gooseai.StageAction
	47, // 61: gooseai.Stage.request:type_name -> gooseai.Request
	48, // 62: gooseai.Stage.on_status:type_name -> gooseai.OnStatus
	49, // 63: gooseai.ChainRequest.stage:type_name -> gooseai.Stage
	47, // 64: gooseai.GenerationService.Generate:input_type -> gooseai.Request
	50, // 65: gooseai.GenerationService.ChainGenerate:input_type -> gooseai.ChainRequest
	45, // 66: gooseai.GenerationService.Generate:output_type -> gooseai.Answer
	45, // 67: gooseai.GenerationService.ChainGenerate:output_type -> gooseai.Answer
