...
type ImageParameters struct {
	...
	Adapter        *T2IAdapterParameter `protobuf:"bytes,12,opt,name=adapter,proto3,oneof" json:"adapter,omitempty"`                                                                   // next available tag: 13
}
...
var file_generation_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x65, 0x72, 0x73, 0x22, 0xc1, 0x05, 0x0a, 0x0f, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x50,
	...
	0x12, 0x3b, 0x0a, 0x07, 0x61, 0x64, 0x61, 0x70, 0x74, 0x65, 0x72, 0x18, 0x0c, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x1c, 0x2e, 0x67, 0x6f, 0x6f, 0x73, 0x65, 0x61, 0x69, 0x2e, 0x54, 0x32, 0x49, 0x41,
	0x64, 0x61, 0x70, 0x74, 0x65, 0x72, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x48,
	0x09, 0x52, 0x07, 0x61, 0x64, 0x61, 0x70, 0x74, 0x65, 0x72, 0x88, 0x01, 0x01, 0x42, 0x09, 0x0a,
...
var file_generation_proto_goTypes = []interface{}{
	...
	(*ImageParameters)(nil),            // 38: gooseai.ImageParameters
	(*ClassifierConcept)(nil),          // 39: gooseai.ClassifierConcept
	(*ClassifierCategory)(nil),         // 40: gooseai.ClassifierCategory
	(*ClassifierParameters)(nil),       // 41: gooseai.ClassifierParameters
	(*InterpolateParameters)(nil),      // 42: gooseai.InterpolateParameters
	(*TransformColorAdjust)(nil),       // 43: gooseai.TransformColorAdjust
	(*TransformDepthCalc)(nil),         // 44: gooseai.TransformDepthCalc
	(*TransformMatrix)(nil),            // 45: gooseai.TransformMatrix
	(*TransformResample)(nil),          // 46: gooseai.TransformResample
	(*CameraParameters)(nil),           // 47: gooseai.CameraParameters
	(*TransformCameraPose)(nil),        // 48: gooseai.TransformCameraPose
	(*TransformParameters)(nil),        // 49: gooseai.TransformParameters
	(*AssetParameters)(nil),            // 50: gooseai.AssetParameters
	(*AnswerMeta)(nil),                 // 51: gooseai.AnswerMeta
	(*Answer)(nil),                     // 52: gooseai.Answer
	(*AnswerBatch)(nil),                // 53: gooseai.AnswerBatch
	(*Request)(nil),                    // 54: gooseai.Request
	(*OnStatus)(nil),                   // 55: gooseai.OnStatus
...
var file_generation_proto_depIdxs = []int32{
	...
	41, // 3: gooseai.Artifact.classifier:type_name -> gooseai.ClassifierParameters
	58, // 4: gooseai.Artifact.tensor:type_name -> tensors.Tensor
	...
	39, // 32: gooseai.ClassifierCategory.concepts:type_name -> gooseai.ClassifierConcept
	10, // 33: gooseai.ClassifierCategory.action:type_name -> gooseai.Action
	11, // 34: gooseai.ClassifierCategory.classifier_mode:type_name -> gooseai.ClassifierMode
	40, // 35: gooseai.ClassifierParameters.categories:type_name -> gooseai.ClassifierCategory
	40, // 36: gooseai.ClassifierParameters.exceeds:type_name -> gooseai.ClassifierCategory
	10, // 37: gooseai.ClassifierParameters.realized_action:type_name -> gooseai.Action
	12, // 38: gooseai.InterpolateParameters.mode:type_name -> gooseai.InterpolateMode
	23, // 39: gooseai.TransformColorAdjust.match_image:type_name -> gooseai.Artifact
	14, // 40: gooseai.TransformColorAdjust.match_mode:type_name -> gooseai.ColorMatchMode
	13, // 41: gooseai.TransformResample.border_mode:type_name -> gooseai.BorderMode
	45, // 42: gooseai.TransformResample.transform:type_name -> gooseai.TransformMatrix
	45, // 43: gooseai.TransformResample.prev_transform:type_name -> gooseai.TransformMatrix
	15, // 44: gooseai.CameraParameters.camera_type:type_name -> gooseai.CameraType
	45, // 45: gooseai.TransformCameraPose.world_to_view_matrix:type_name -> gooseai.TransformMatrix
	47, // 46: gooseai.TransformCameraPose.camera_parameters:type_name -> gooseai.CameraParameters
	16, // 47: gooseai.TransformCameraPose.render_mode:type_name -> gooseai.RenderMode
	43, // 48: gooseai.TransformParameters.color_adjust:type_name -> gooseai.TransformColorAdjust
	44, // 49: gooseai.TransformParameters.depth_calc:type_name -> gooseai.TransformDepthCalc
	46, // 50: gooseai.TransformParameters.resample:type_name -> gooseai.TransformResample
	48, // 51: gooseai.TransformParameters.camera_pose:type_name -> gooseai.TransformCameraPose
	17, // 52: gooseai.AssetParameters.action:type_name -> gooseai.AssetAction
	18, // 53: gooseai.AssetParameters.use:type_name -> gooseai.AssetUse
	51, // 54: gooseai.Answer.meta:type_name -> gooseai.AnswerMeta
	23, // 55: gooseai.Answer.artifacts:type_name -> gooseai.Artifact
	52, // 56: gooseai.AnswerBatch.answers:type_name -> gooseai.Answer
	1,  // 57: gooseai.Request.requested_type:type_name -> gooseai.ArtifactType
	25, // 58: gooseai.Request.prompt:type_name -> gooseai.Prompt
	38, // 59: gooseai.Request.image:type_name -> gooseai.ImageParameters
	41, // 60: gooseai.Request.classifier:type_name -> gooseai.ClassifierParameters
	50, // 61: gooseai.Request.asset:type_name -> gooseai.AssetParameters
	42, // 62: gooseai.Request.interpolate:type_name -> gooseai.InterpolateParameters
	49, // 63: gooseai.Request.transform:type_name -> gooseai.TransformParameters
	27, // 64: gooseai.Request.conditioner:type_name -> gooseai.ConditionerParameters
	59, // 65: gooseai.Request.extras:type_name -> google.protobuf.Struct
	0,  // 66: gooseai.OnStatus.reason:type_name -> gooseai.FinishReason
	19, // 67: gooseai.OnStatus.action:type_name -> gooseai.StageAction
	54, // 68: gooseai.Stage.request:type_name -> gooseai.Request
	55, // 69: gooseai.Stage.on_status:type_name -> gooseai.OnStatus
	56, // 70: gooseai.ChainRequest.stage:type_name -> gooseai.Stage
	54, // 71: gooseai.GenerationService.Generate:input_type -> gooseai.Request
	57, // 72: gooseai.GenerationService.ChainGenerate:input_type -> gooseai.ChainRequest
	52, // 73: gooseai.GenerationService.Generate:output_type -> gooseai.Answer
	52, // 74: gooseai.GenerationService.ChainGenerate:output_type -> gooseai.Answer
