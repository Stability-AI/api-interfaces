...
type EstimateCostResponse struct {
	...
	TotalCreditCost float64 `protobuf:"fixed64,1,opt,name=total_credit_cost,json=totalCreditCost,proto3" json:"total_credit_cost,omitempty"`
}
...
func (x *EstimateCostResponse) GetTotalCreditCost() float64 {
	if x != nil {
		return x.TotalCreditCost
	}
	return 0
}
...
var file_generation_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x6d, 0x22, 0x42, 0x0a, 0x14, 0x45, 0x73, 0x74, 0x69, 0x6d, 0x61, 0x74, 0x65, 0x43,
	0x6f, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2a, 0x0a, 0x11, 0x74,
	0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x63, 0x72, 0x65, 0x64, 0x69, 0x74, 0x5f, 0x63, 0x6f, 0x73, 0x74,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0f, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x43, 0x72, 0x65,
	0x64, 0x69, 0x74, 0x43, 0x6f, 0x73, 0x74, 0x22, 0x5e, 0x0a, 0x11, 0x43, 0x6c, 0x61, 0x73, 0x73,
	...
	0xc6, 0x01, 0x0a, 0x11, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65,
	...
	0x72, 0x22, 0x00, 0x30, 0x01, 0x12, 0x41, 0x0a, 0x0c, 0x45, 0x73, 0x74, 0x69, 0x6d, 0x61, 0x74,
	0x65, 0x43, 0x6f, 0x73, 0x74, 0x12, 0x10, 0x2e, 0x67, 0x6f, 0x6f, 0x73, 0x65, 0x61, 0x69, 0x2e,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1d, 0x2e, 0x67, 0x6f, 0x6f, 0x73, 0x65, 0x61,
	0x69, 0x2e, 0x45, 0x73, 0x74, 0x69, 0x6d, 0x61, 0x74, 0x65, 0x43, 0x6f, 0x73, 0x74, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x0f, 0x5a, 0x0d, 0x2e, 0x2f, 0x3b, 0x67,
...
var file_generation_proto_goTypes = []interface{}{
	...
	(*EstimateCostResponse)(nil),       // 27: gooseai.EstimateCostResponse
...
var file_generation_proto_depIdxs = []int32{
	...
	28, // 24: gooseai.ClassifierCategory.concepts:type_name -> gooseai.ClassifierConcept
	...
	29, // 27: gooseai.ClassifierParameters.categories:type_name -> gooseai.ClassifierCategory
	29, // 28: gooseai.ClassifierParameters.exceeds:type_name -> gooseai.ClassifierCategory
	...
	32, // 32: gooseai.Answer.meta:type_name -> gooseai.AnswerMeta
	...
	30, // 37: gooseai.Request.classifier:type_name -> gooseai.ClassifierParameters
	31, // 38: gooseai.Request.asset:type_name -> gooseai.AssetParameters
	...
	34, // 42: gooseai.Stage.request:type_name -> gooseai.Request
	35, // 43: gooseai.Stage.on_status:type_name -> gooseai.OnStatus
	36, // 44: gooseai.ChainRequest.stage:type_name -> gooseai.Stage
	34, // 45: gooseai.GenerationService.Generate:input_type -> gooseai.Request
	37, // 46: gooseai.GenerationService.ChainGenerate:input_type -> gooseai.ChainRequest
	34, // 47: gooseai.GenerationService.EstimateCost:input_type -> gooseai.Request
	33, // 48: gooseai.GenerationService.Generate:output_type -> gooseai.Answer
	33, // 49: gooseai.GenerationService.ChainGenerate:output_type -> gooseai.Answer
	27, // 50: gooseai.GenerationService.EstimateCost:output_type -> gooseai.EstimateCostResponse
