...
goog.exportSymbol('proto.gooseai.FineTuningJobRequestByOrgId', null, global);
 ...
 * @constructor
 */
proto.gooseai.FineTuningJobRequestByOrgId = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.gooseai.FineTuningJobRequestByOrgId, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.gooseai.FineTuningJobRequestByOrgId.displayName = 'proto.gooseai.FineTuningJobRequestByOrgId';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.gooseai.FineTuningJobRequestByOrgId.prototype.toObject = function(opt_includeInstance) {
  return proto.gooseai.FineTuningJobRequestByOrgId.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gooseai.FineTuningJobRequestByOrgId} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.FineTuningJobRequestByOrgId.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.gooseai.FineTuningJobRequestByOrgId}
 */
proto.gooseai.FineTuningJobRequestByOrgId.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gooseai.FineTuningJobRequestByOrgId;
  return proto.gooseai.FineTuningJobRequestByOrgId.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gooseai.FineTuningJobRequestByOrgId} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gooseai.FineTuningJobRequestByOrgId}
 */
proto.gooseai.FineTuningJobRequestByOrgId.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.gooseai.FineTuningJobRequestByOrgId.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gooseai.FineTuningJobRequestByOrgId.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gooseai.FineTuningJobRequestByOrgId} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gooseai.FineTuningJobRequestByOrgId.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.gooseai.FineTuningJobRequestByOrgId.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.gooseai.FineTuningJobRequestByOrgId} returns this
 */
proto.gooseai.FineTuningJobRequestByOrgId.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
