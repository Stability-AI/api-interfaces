...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\rengines.proto\x12\x07\x61nlatan\"Y\n\nEngineInfo\x12\n\n\x02id\x18\x01 \x01(\t\x12\r\n\x05owner\x18\x02 \x01(\t\x12\r\n\x05ready\x18\x03 \x01(\x08\x12!\n\x04type\x18\x04 \x01(\x0e\x32\x13.anlatan.EngineType\"\x14\n\x12ListEnginesRequest\".\n\x07\x45ngines\x12#\n\x06\x65ngine\x18\x01 \x03(\x0b\x32\x13.anlatan.EngineInfo*9\n\nEngineType\x12\x08\n\x04TEXT\x10\x00\x12\x0b\n\x07PICTURE\x10\x01\x12\t\n\x05\x41UDIO\x10\x02\x12\t\n\x05VIDEO\x10\x03\x32P\n\x0e\x45nginesService\x12>\n\x0bListEngines\x12\x1b.anlatan.ListEnginesRequest\x1a\x10.anlatan.Engines\"\x00\x42\x0cZ\n./;enginesb\x06proto3'
)

_ENGINETYPE = _descriptor.EnumDescriptor(
  name='EngineType',
  full_name='anlatan.EngineType',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_ENGINEINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='anlatan.EngineInfo.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='owner', full_name='anlatan.EngineInfo.owner', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='ready', full_name='anlatan.EngineInfo.ready', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='type', full_name='anlatan.EngineInfo.type', index=3,
...
_LISTENGINESREQUEST = _descriptor.Descriptor(
  ...
  full_name='anlatan.ListEnginesRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_ENGINES = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='engine', full_name='anlatan.Engines.engine', index=0,
...
EngineInfo = _reflection.GeneratedProtocolMessageType('EngineInfo', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:anlatan.EngineInfo)
  })
...
ListEnginesRequest = _reflection.GeneratedProtocolMessageType('ListEnginesRequest', (_message.Message,), {
  ...
  '__module__' : 'engines_pb2'
  # @@protoc_insertion_point(class_scope:anlatan.ListEnginesRequest)
  })
...
Engines = _reflection.GeneratedProtocolMessageType('Engines', (_message.Message,), {
  'DESCRIPTOR' : _ENGINES,
  '__module__' : 'engines_pb2'
  # @@protoc_insertion_point(class_scope:anlatan.Engines)
  })
...
_ENGINESSERVICE = _descriptor.ServiceDescriptor(
  name='EnginesService',
  full_name='anlatan.EnginesService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='ListEngines',
    full_name='anlatan.EnginesService.ListEngines',
    index=0,
