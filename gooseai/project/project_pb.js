...
goog.object.extend(proto, generation_generation_pb);
...
proto.gooseai.ProjectAsset.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    request: (f = msg.getRequest()) && generation_generation_pb.Request.toObject(includeInstance, f)
  };
...
proto.gooseai.ProjectAsset.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 7:
      ...
      break;
    case 8:
      var value = new generation_generation_pb.Request;
      reader.readMessage(value,generation_generation_pb.Request.deserializeBinaryFromReader);
...
proto.gooseai.ProjectAsset.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      8,
      f,
      generation_generation_pb.Request.serializeBinaryToWriter
    );
  }
};
...
proto.gooseai.ProjectAsset.prototype.getRequest = function() {
  return /** @type{?proto.gooseai.Request} */ (
    jspb.Message.getWrapperField(this, generation_generation_pb.Request, 8));
};
