...
var generation_generation_pb = require('../generation/generation_pb.js');
...
function serialize_gooseai_DeleteProjectRequest(arg) {
  if (!(arg instanceof project_project_pb.DeleteProjectRequest)) {
...
function deserialize_gooseai_DeleteProjectRequest(buffer_arg) {
  return project_project_pb.DeleteProjectRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_gooseai_ListProjectRequest(arg) {
  if (!(arg instanceof project_project_pb.ListProjectRequest)) {
...
function deserialize_gooseai_ListProjectRequest(buffer_arg) {
  return project_project_pb.ListProjectRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_Project(arg) {
  if (!(arg instanceof project_project_pb.Project)) {
...
function deserialize_gooseai_Project(buffer_arg) {
  return project_project_pb.Project.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_QueryAssetsRequest(arg) {
  if (!(arg instanceof project_project_pb.QueryAssetsRequest)) {
...
function deserialize_gooseai_QueryAssetsRequest(buffer_arg) {
  return project_project_pb.QueryAssetsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_QueryAssetsResponse(arg) {
  if (!(arg instanceof project_project_pb.QueryAssetsResponse)) {
...
function deserialize_gooseai_QueryAssetsResponse(buffer_arg) {
  return project_project_pb.QueryAssetsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_gooseai_UpdateProjectRequest(arg) {
  if (!(arg instanceof project_project_pb.UpdateProjectRequest)) {
...
function deserialize_gooseai_UpdateProjectRequest(buffer_arg) {
  return project_project_pb.UpdateProjectRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
