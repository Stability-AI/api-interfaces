...
type QueryAssetsRequest struct {
	...
	Id      string            `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`                                        // ID of the project to request, UUIDv4, empty string uses default project
	OwnerId *string           `protobuf:"bytes,2,opt,name=owner_id,json=ownerId,proto3,oneof" json:"owner_id,omitempty"`         // The ID of the organization owning the assets, empty for default org for user
	Since   *uint64           `protobuf:"varint,3,opt,name=since,proto3,oneof" json:"since,omitempty"`                           // The unix time to start listing assets from, empty for no restriction
	Until   *uint64           `protobuf:"varint,4,opt,name=until,proto3,oneof" json:"until,omitempty"`                           // The unix time to stop listing assets at, empty for no restriction
	Limit   *uint64           `protobuf:"varint,5,opt,name=limit,proto3,oneof" json:"limit,omitempty"`                           // The maximum number of assets to return, empty for no limit
	Offest  *uint64           `protobuf:"varint,6,opt,name=offest,proto3,oneof" json:"offest,omitempty"`                         // The starting offset when returning assets, empty for no offset
...
func (x *QueryAssetsRequest) GetOffest() uint64 {
	if x != nil && x.Offest != nil {
		return *x.Offest
	}
	return 0
}
...
var file_project_proto_rawDesc = []byte{
	...
	0x5f, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x22, 0x94, 0x02, 0x0a, 0x12, 0x51, 0x75,
	...
	0x12, 0x19, 0x0a, 0x05, 0x73, 0x69, 0x6e, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x48,
	0x01, 0x52, 0x05, 0x73, 0x69, 0x6e, 0x63, 0x65, 0x88, 0x01, 0x01, 0x12, 0x19, 0x0a, 0x05, 0x75,
	0x6e, 0x74, 0x69, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x48, 0x02, 0x52, 0x05, 0x75, 0x6e,
	0x74, 0x69, 0x6c, 0x88, 0x01, 0x01, 0x12, 0x19, 0x0a, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x04, 0x48, 0x03, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x88, 0x01,
	0x01, 0x12, 0x1b, 0x0a, 0x06, 0x6f, 0x66, 0x66, 0x65, 0x73, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x04, 0x48, 0x04, 0x52, 0x06, 0x6f, 0x66, 0x66, 0x65, 0x73, 0x74, 0x88, 0x01, 0x01, 0x12, 0x2a,
	...
	,
	...
	0x12, 0x3b, 0x0a, 0x06, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x1d, 0x2e, 0x67, 0x6f, 0x6f,
	0x73, 0x65, 0x61, 0x69, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x6a, 0x65,
	0x63, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x10, 0x2e, 0x67, 0x6f, 0x6f, 0x73,
	0x65, 0x61, 0x69, 0x2e, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x22, 0x00, 0x12, 0x39, 0x0a,
	0x04, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x1b, 0x2e, 0x67, 0x6f, 0x6f, 0x73, 0x65, 0x61, 0x69, 0x2e,
	...
	0x6a, 0x65, 0x63, 0x74, 0x22, 0x00, 0x30, 0x01, 0x12, 0x35, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12,
	0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x73, 0x65, 0x61, 0x69, 0x2e, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f,
	...
	0x3b, 0x0a, 0x06, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x12, 0x1d, 0x2e, 0x67, 0x6f, 0x6f, 0x73,
	0x65, 0x61, 0x69, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63,
	0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x10, 0x2e, 0x67, 0x6f, 0x6f, 0x73, 0x65,
	0x61, 0x69, 0x2e, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x22, 0x00, 0x12, 0x45, 0x0a, 0x0b,
	...
	0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x67, 0x6f, 0x6f, 0x73, 0x65,
	0x61, 0x69, 0x2e, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x41, 0x73, 0x73, 0x65, 0x74, 0x22,
	0x00, 0x30, 0x01, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x3b, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63,
...
var file_project_proto_depIdxs = []int32{
	...
	2,  // 11: gooseai.QueryAssetsRequest.use:type_name -> gooseai.ProjectAssetUse
	5,  // 12: gooseai.ProjectService.Create:input_type -> gooseai.CreateProjectRequest
	6,  // 13: gooseai.ProjectService.Update:input_type -> gooseai.UpdateProjectRequest
	7,  // 14: gooseai.ProjectService.List:input_type -> gooseai.ListProjectRequest
	8,  // 15: gooseai.ProjectService.Get:input_type -> gooseai.GetProjectRequest
	9,  // 16: gooseai.ProjectService.Delete:input_type -> gooseai.DeleteProjectRequest
	10, // 17: gooseai.ProjectService.QueryAssets:input_type -> gooseai.QueryAssetsRequest
	4,  // 18: gooseai.ProjectService.Create:output_type -> gooseai.Project
	4,  // 19: gooseai.ProjectService.Update:output_type -> gooseai.Project
	4,  // 20: gooseai.ProjectService.List:output_type -> gooseai.Project
	4,  // 21: gooseai.ProjectService.Get:output_type -> gooseai.Project
	4,  // 22: gooseai.ProjectService.Delete:output_type -> gooseai.Project
	3,  // 23: gooseai.ProjectService.QueryAssets:output_type -> gooseai.ProjectAsset
