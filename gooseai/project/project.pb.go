...
const (
	ProjectAssetUse_PROJECT_ASSET_USE_INPUT        ProjectAssetUse = 0 // Asset is used as an input for the project
	ProjectAssetUse_PROJECT_ASSET_USE_OUTPUT       ProjectAssetUse = 1 // Asset is an output from the project
	ProjectAssetUse_PROJECT_ASSET_USE_INTERMEDIATE ProjectAssetUse = 2 // Asset is an output from an intermediate step of the project
	ProjectAssetUse_PROJECT_ASSET_USE_PROJECT      ProjectAssetUse = 3 // Asset is used as the project file for the project
)

// Enum value maps for ProjectAssetUse.
var (
	ProjectAssetUse_name = map[int32]string{
		0: "PROJECT_ASSET_USE_INPUT",
		1: "PROJECT_ASSET_USE_OUTPUT",
		2: "PROJECT_ASSET_USE_INTERMEDIATE",
		3: "PROJECT_ASSET_USE_PROJECT",
	}
...
type ProjectAsset struct {
	...
	Id  uint64          `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`                                // ID of the asset
...
func (x *ProjectAsset) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *ProjectAsset) GetUse() ProjectAssetUse {
	...
	return ProjectAssetUse_PROJECT_ASSET_USE_INPUT
}
...
type Project struct {
	...
	Id        uint64          `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`                                    // ID of the project
	Title     string          `protobuf:"bytes,2,opt,name=title,proto3" json:"title,omitempty"`                               // Title of the project
	Owner     string          `protobuf:"bytes,3,opt,name=owner,proto3" json:"owner,omitempty"`                               // The ID of the organization owning the project
...
type CreateProjectRequest struct {
	...
	Owner  *string       `protobuf:"bytes,2,opt,name=owner,proto3,oneof" json:"owner,omitempty"`                         // The ID of the organization owning the project, empty for default org for user
...
func (x *UpdateProjectRequest) GetOwner() string {
	if x != nil && x.Owner != nil {
		return *x.Owner
	}
	return ""
...
type ListProjectRequest struct {
	...
	Owner *string `protobuf:"bytes,1,opt,name=owner,proto3,oneof" json:"owner,omitempty"` // The ID of the organization owning the project, empty for default org for user
}
...
func (x *ListProjectRequest) GetOwner() string {
	if x != nil && x.Owner != nil {
		return *x.Owner
	}
	return ""
...
type GetDeleteProjectRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Id    uint64  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`            // ID of the project to request
	Owner *string `protobuf:"bytes,2,opt,name=owner,proto3,oneof" json:"owner,omitempty"` // The ID of the organization owning the project, empty for default org for user
}

func (x *GetDeleteProjectRequest) Reset() {
	*x = GetDeleteProjectRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetDeleteProjectRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetDeleteProjectRequest) ProtoMessage() {}

func (x *GetDeleteProjectRequest) ProtoReflect() protoreflect.Message {
	mi := &file_project_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetDeleteProjectRequest.ProtoReflect.Descriptor instead.
func (*GetDeleteProjectRequest) Descriptor() ([]byte, []int) {
	return file_project_proto_rawDescGZIP(), []int{5}
}

func (x *GetDeleteProjectRequest) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *GetDeleteProjectRequest) GetOwner() string {
	if x != nil && x.Owner != nil {
		return *x.Owner
	}
	return ""
...
var file_project_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x55, 0x52, 0x49, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x55, 0x52, 0x49, 0x12, 0x2a, 0x0a, 0x03, 0x75, 0x73,
	...
	0x65, 0x52, 0x03, 0x75, 0x73, 0x65, 0x22, 0xd1, 0x02, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x6a, 0x65,
	...
	0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x12, 0x2e,
	0x0a, 0x06, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x16,
	...
	0x7a, 0x65, 0x12, 0x29, 0x0a, 0x04, 0x66, 0x69, 0x6c, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x15, 0x2e, 0x67, 0x6f, 0x6f, 0x73, 0x65, 0x61, 0x69, 0x2e, 0x50, 0x72, 0x6f, 0x6a, 0x65,
	0x63, 0x74, 0x41, 0x73, 0x73, 0x65, 0x74, 0x52, 0x04, 0x66, 0x69, 0x6c, 0x65, 0x12, 0x1d, 0x0a,
	...
	0x52, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x12, 0x2d, 0x0a, 0x06, 0x61,
	0x73, 0x73, 0x65, 0x74, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x67, 0x6f,
	0x6f, 0x73, 0x65, 0x61, 0x69, 0x2e, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x41, 0x73, 0x73,
	0x65, 0x74, 0x52, 0x06, 0x61, 0x73, 0x73, 0x65, 0x74, 0x73, 0x22, 0xea, 0x01, 0x0a, 0x14, 0x43,
	...
	0x28, 0x09, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x12, 0x19, 0x0a, 0x05, 0x6f, 0x77, 0x6e,
	0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x05, 0x6f, 0x77, 0x6e, 0x65,
	0x72, 0x88, 0x01, 0x01, 0x12, 0x2e, 0x0a, 0x06, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0x03,
	...
	,
	...
	0x00, 0x52, 0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x88, 0x01, 0x01, 0x12, 0x19, 0x0a, 0x05, 0x74,
	...
	,
	...
	0x42, 0x4c, 0x49, 0x43, 0x10, 0x01, 0x2a, 0x47, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63,
	...
	0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x41, 0x43, 0x54, 0x49, 0x56, 0x45, 0x10, 0x01, 0x2a,
	0x8f, 0x01, 0x0a, 0x0f, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x41, 0x73, 0x73, 0x65, 0x74,
	0x55, 0x73, 0x65, 0x12, 0x1b, 0x0a, 0x17, 0x50, 0x52, 0x4f, 0x4a, 0x45, 0x43, 0x54, 0x5f, 0x41,
	0x53, 0x53, 0x45, 0x54, 0x5f, 0x55, 0x53, 0x45, 0x5f, 0x49, 0x4e, 0x50, 0x55, 0x54, 0x10, 0x00,
	0x12, 0x1c, 0x0a, 0x18, 0x50, 0x52, 0x4f, 0x4a, 0x45, 0x43, 0x54, 0x5f, 0x41, 0x53, 0x53, 0x45,
	0x54, 0x5f, 0x55, 0x53, 0x45, 0x5f, 0x4f, 0x55, 0x54, 0x50, 0x55, 0x54, 0x10, 0x01, 0x12, 0x22,
	...
	0x10, 0x02, 0x12, 0x1d, 0x0a, 0x19, 0x50, 0x52, 0x4f, 0x4a, 0x45, 0x43, 0x54, 0x5f, 0x41, 0x53,
	0x53, 0x45, 0x54, 0x5f, 0x55, 0x53, 0x45, 0x5f, 0x50, 0x52, 0x4f, 0x4a, 0x45, 0x43, 0x54, 0x10,
	0x03, 0x32, 0xc7, 0x02, 0x0a, 0x0e, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x53, 0x65, 0x72,
	...
	0x6f, 0x6a, 0x65, 0x63, 0x74, 0x22, 0x00, 0x30, 0x01, 0x12, 0x3b, 0x0a, 0x03, 0x47, 0x65, 0x74,
	0x12, 0x20, 0x2e, 0x67, 0x6f, 0x6f, 0x73, 0x65, 0x61, 0x69, 0x2e, 0x47, 0x65, 0x74, 0x44, 0x65,
	...
	0x6a, 0x65, 0x63, 0x74, 0x22, 0x00, 0x12, 0x43, 0x0a, 0x06, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65,
	0x12, 0x20, 0x2e, 0x67, 0x6f, 0x6f, 0x73, 0x65, 0x61, 0x69, 0x2e, 0x47, 0x65, 0x74, 0x44, 0x65,
	0x6c, 0x65, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x15, 0x2e, 0x67, 0x6f, 0x6f, 0x73, 0x65, 0x61, 0x69, 0x2e, 0x50, 0x72, 0x6f,
	0x6a, 0x65, 0x63, 0x74, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x42, 0x0c, 0x5a, 0x0a, 0x2e,
	0x2f, 0x3b, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_project_proto_goTypes = []interface{}{
	...
	(*GetDeleteProjectRequest)(nil), // 8: gooseai.GetDeleteProjectRequest
	(*ProjectEmpty)(nil),            // 9: gooseai.ProjectEmpty
}
var file_project_proto_depIdxs = []int32{
	...
	8,  // 14: gooseai.ProjectService.Get:input_type -> gooseai.GetDeleteProjectRequest
	8,  // 15: gooseai.ProjectService.Delete:input_type -> gooseai.GetDeleteProjectRequest
	...
	9,  // 20: gooseai.ProjectService.Delete:output_type -> gooseai.ProjectEmpty
...
func file_project_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_project_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetDeleteProjectRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
