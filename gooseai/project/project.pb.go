...
type ProjectAsset struct {
	...
	Id  []byte          `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`                                 // ID of the asset, UUIDv4
...
func (x *ProjectAsset) GetId() []byte {
	if x != nil {
		return x.Id
	}
	return nil
...
type Project struct {
	...
	Id        []byte          `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`                                     // ID of the project, UUIDv4
...
func (x *UpdateProjectRequest) GetId() []byte {
	if x != nil {
		return x.Id
	}
	return nil
...
type GetProjectRequest struct {
	...
	Id      []byte  `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`                                // ID of the project to request, UUIDv4
	OwnerId *string `protobuf:"bytes,2,opt,name=owner_id,json=ownerId,proto3,oneof" json:"owner_id,omitempty"` // The ID of the organization owning the project, empty for default org for user
}
...
var file_project_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x02, 0x69, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x55, 0x52, 0x49, 0x18,
	...
	0x0c, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1e, 0x0a, 0x08, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x5f, 0x69,
