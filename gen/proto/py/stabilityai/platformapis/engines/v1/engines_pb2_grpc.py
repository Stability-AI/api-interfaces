...
from stabilityai.platformapis.engines.v1 import engines_pb2 as stabilityai_dot_platformapis_dot_engines_dot_v1_dot_engines__pb2
...
class EnginesServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListEngines = channel.unary_unary(
                ...
                request_serializer=stabilityai_dot_platformapis_dot_engines_dot_v1_dot_engines__pb2.ListEnginesRequest.SerializeToString,
                response_deserializer=stabilityai_dot_platformapis_dot_engines_dot_v1_dot_engines__pb2.Engines.FromString,
                )
...
def add_EnginesServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ListEngines': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=stabilityai_dot_platformapis_dot_engines_dot_v1_dot_engines__pb2.ListEnginesRequest.FromString,
...
class EnginesService(object):
    ...
    def ListEngines(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/stabilityai.platformapis.engines.v1.EnginesService/ListEngines',
            stabilityai_dot_platformapis_dot_engines_dot_v1_dot_engines__pb2.ListEnginesRequest.SerializeToString,
            stabilityai_dot_platformapis_dot_engines_dot_v1_dot_engines__pb2.Engines.FromString,
