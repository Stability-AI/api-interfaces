...
class GenerationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Generate = channel.unary_stream(
                ...
                request_serializer=gooseai_dot_generation__pb2.Request.SerializeToString,
                response_deserializer=gooseai_dot_generation__pb2.Answer.FromString,
                )
        self.ChainGenerate = channel.unary_stream(
                '/gooseai.GenerationService/ChainGenerate',
                request_serializer=gooseai_dot_generation__pb2.ChainRequest.SerializeToString,
                response_deserializer=gooseai_dot_generation__pb2.Answer.FromString,
                )
...
def add_GenerationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Generate': grpc.unary_stream_rpc_method_handler(
                    servicer.Generate,
                    request_deserializer=gooseai_dot_generation__pb2.Request.FromString,
                    response_serializer=gooseai_dot_generation__pb2.Answer.SerializeToString,
            ),
            'ChainGenerate': grpc.unary_stream_rpc_method_handler(
                    servicer.ChainGenerate,
                    request_deserializer=gooseai_dot_generation__pb2.ChainRequest.FromString,
                    response_serializer=gooseai_dot_generation__pb2.Answer.SerializeToString,
            ),
    }
...
class GenerationService(object):
    ...
    def Generate(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/gooseai.GenerationService/Generate',
            gooseai_dot_generation__pb2.Request.SerializeToString,
            gooseai_dot_generation__pb2.Answer.FromString,
    ...
    def ChainGenerate(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/gooseai.GenerationService/ChainGenerate',
            gooseai_dot_generation__pb2.ChainRequest.SerializeToString,
            gooseai_dot_generation__pb2.Answer.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
