...
@kotlin.jvm.JvmName("-initializetagAssetsResponse")
public inline fun tagAssetsResponse(block: com.stabilityai.platformapis.project.v1.TagAssetsResponseKt.Dsl.() -> kotlin.Unit): com.stabilityai.platformapis.project.v1.TagAssetsResponse =
  com.stabilityai.platformapis.project.v1.TagAssetsResponseKt.Dsl._create(com.stabilityai.platformapis.project.v1.TagAssetsResponse.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `stabilityai.platformapis.project.v1.TagAssetsResponse`
 */
public object TagAssetsResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.stabilityai.platformapis.project.v1.TagAssetsResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: com.stabilityai.platformapis.project.v1.TagAssetsResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): com.stabilityai.platformapis.project.v1.TagAssetsResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.stabilityai.platformapis.project.v1.TagAssetsResponse.copy(block: com.stabilityai.platformapis.project.v1.TagAssetsResponseKt.Dsl.() -> kotlin.Unit): com.stabilityai.platformapis.project.v1.TagAssetsResponse =
  com.stabilityai.platformapis.project.v1.TagAssetsResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
