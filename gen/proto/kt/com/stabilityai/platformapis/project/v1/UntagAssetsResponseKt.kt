...
@kotlin.jvm.JvmName("-initializeuntagAssetsResponse")
public inline fun untagAssetsResponse(block: com.stabilityai.platformapis.project.v1.UntagAssetsResponseKt.Dsl.() -> kotlin.Unit): com.stabilityai.platformapis.project.v1.UntagAssetsResponse =
  com.stabilityai.platformapis.project.v1.UntagAssetsResponseKt.Dsl._create(com.stabilityai.platformapis.project.v1.UntagAssetsResponse.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `stabilityai.platformapis.project.v1.UntagAssetsResponse`
 */
public object UntagAssetsResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.stabilityai.platformapis.project.v1.UntagAssetsResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: com.stabilityai.platformapis.project.v1.UntagAssetsResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): com.stabilityai.platformapis.project.v1.UntagAssetsResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.stabilityai.platformapis.project.v1.UntagAssetsResponse.copy(block: com.stabilityai.platformapis.project.v1.UntagAssetsResponseKt.Dsl.() -> kotlin.Unit): com.stabilityai.platformapis.project.v1.UntagAssetsResponse =
  com.stabilityai.platformapis.project.v1.UntagAssetsResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
