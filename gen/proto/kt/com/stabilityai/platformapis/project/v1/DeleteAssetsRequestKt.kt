...
@kotlin.jvm.JvmName("-initializedeleteAssetsRequest")
public inline fun deleteAssetsRequest(block: com.stabilityai.platformapis.project.v1.DeleteAssetsRequestKt.Dsl.() -> kotlin.Unit): com.stabilityai.platformapis.project.v1.DeleteAssetsRequest =
  com.stabilityai.platformapis.project.v1.DeleteAssetsRequestKt.Dsl._create(com.stabilityai.platformapis.project.v1.DeleteAssetsRequest.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `stabilityai.platformapis.project.v1.DeleteAssetsRequest`
 */
public object DeleteAssetsRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.stabilityai.platformapis.project.v1.DeleteAssetsRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: com.stabilityai.platformapis.project.v1.DeleteAssetsRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): com.stabilityai.platformapis.project.v1.DeleteAssetsRequest = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.stabilityai.platformapis.project.v1.DeleteAssetsRequest.copy(block: com.stabilityai.platformapis.project.v1.DeleteAssetsRequestKt.Dsl.() -> kotlin.Unit): com.stabilityai.platformapis.project.v1.DeleteAssetsRequest =
  com.stabilityai.platformapis.project.v1.DeleteAssetsRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()
