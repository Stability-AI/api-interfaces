...
const (
	GenerationService_Generate_FullMethodName      = "/stabilityai.platformapis.generation.v1.GenerationService/Generate"
	GenerationService_ChainGenerate_FullMethodName = "/stabilityai.platformapis.generation.v1.GenerationService/ChainGenerate"
)
...
func (c *generationServiceClient) Generate(ctx context.Context, in *Request, opts ...grpc.CallOption) (GenerationService_GenerateClient, error) {
	stream, err := c.cc.NewStream(ctx, &GenerationService_ServiceDesc.Streams[0], GenerationService_Generate_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *generationServiceClient) ChainGenerate(ctx context.Context, in *ChainRequest, opts ...grpc.CallOption) (GenerationService_ChainGenerateClient, error) {
	stream, err := c.cc.NewStream(ctx, &GenerationService_ServiceDesc.Streams[1], GenerationService_ChainGenerate_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
var GenerationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "stabilityai.platformapis.generation.v1.GenerationService",
	...
	Metadata: "stabilityai/platformapis/generation/v1/generation.proto",
}
