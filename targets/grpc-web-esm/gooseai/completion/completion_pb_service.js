...
// completion/completion_pb_service.js
var require_completion_pb_service = __commonJS({
  "completion/completion_pb_service.js"(exports) {
    var completion_pb = require_completion_pb();
    var grpc = __require("@improbable-eng/grpc-web").grpc;
    var CompletionService = function() {
      function CompletionService2() {
      }
      CompletionService2.serviceName = "gooseai.CompletionService";
...
export default require_completion_pb_service();
