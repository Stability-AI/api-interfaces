...
var require_generation_pb_service = __commonJS({
  "generation/generation_pb_service.js"(exports) {
    var generation_pb = require_generation_pb();
    var grpc = __require("@improbable-eng/grpc-web").grpc;
    var GenerationService = function() {
      function GenerationService2() {
      }
      GenerationService2.serviceName = "gooseai.GenerationService";
      return GenerationService2;
    }();
...
export default require_generation_pb_service();
