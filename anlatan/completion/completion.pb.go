...
type ModelTransform struct {
	...
	//	*ModelTransform_Temperature
	//	*ModelTransform_TopP
	//	*ModelTransform_TopK
	//	*ModelTransform_TailFreeSampling
	Transform isModelTransform_Transform `protobuf_oneof:"transform"`
}

func (x *ModelTransform) Reset() {
	*x = ModelTransform{}
	if protoimpl.UnsafeEnabled {
...
func (x *ModelTransform) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ModelTransform) ProtoMessage() {}

func (x *ModelTransform) ProtoReflect() protoreflect.Message {
	mi := &file_completion_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ModelTransform.ProtoReflect.Descriptor instead.
func (*ModelTransform) Descriptor() ([]byte, []int) {
	return file_completion_proto_rawDescGZIP(), []int{6}
}

func (m *ModelTransform) GetTransform() isModelTransform_Transform {
	if m != nil {
		return m.Transform
	}
	return nil
...
func (x *ModelTransform) GetTemperature() float64 {
	if x, ok := x.GetTransform().(*ModelTransform_Temperature); ok {
		return x.Temperature
	}
	return 0
}

func (x *ModelTransform) GetTopP() float64 {
	if x, ok := x.GetTransform().(*ModelTransform_TopP); ok {
		return x.TopP
	}
	return 0
}

func (x *ModelTransform) GetTopK() float64 {
	if x, ok := x.GetTransform().(*ModelTransform_TopK); ok {
		return x.TopK
	}
	return 0
}

func (x *ModelTransform) GetTailFreeSampling() float64 {
	if x, ok := x.GetTransform().(*ModelTransform_TailFreeSampling); ok {
		return x.TailFreeSampling
	}
	return 0
}

type isModelTransform_Transform interface {
	isModelTransform_Transform()
}

type ModelTransform_Temperature struct {
	Temperature float64 `protobuf:"fixed64,1,opt,name=temperature,proto3,oneof"` // OAI: What sampling temperature to use.
}

type ModelTransform_TopP struct {
	TopP float64 `protobuf:"fixed64,2,opt,name=top_p,json=topP,proto3,oneof"` // OAI: nucleus sampling value
}

type ModelTransform_TopK struct {
	TopK float64 `protobuf:"fixed64,3,opt,name=top_k,json=topK,proto3,oneof"` // ANL: truncates logits to highest N value
}

type ModelTransform_TailFreeSampling struct {
	TailFreeSampling float64 `protobuf:"fixed64,4,opt,name=tail_free_sampling,json=tailFreeSampling,proto3,oneof"` // ANL: tail free sampling algorithm
}

func (*ModelTransform_Temperature) isModelTransform_Transform() {}

func (*ModelTransform_TopP) isModelTransform_Transform() {}

func (*ModelTransform_TopK) isModelTransform_Transform() {}

func (*ModelTransform_TailFreeSampling) isModelTransform_Transform() {}
...
type SamplingParams struct {
	...
	Order            []SamplingMethod `protobuf:"varint,1,rep,packed,name=order,proto3,enum=anlatan.SamplingMethod" json:"order,omitempty"`                     // ANL: Order to apply transforms to
	...
	TopK             *float64         `protobuf:"fixed64,4,opt,name=top_k,json=topK,proto3,oneof" json:"top_k,omitempty"`                                       // ANL: truncates logits to highest N
...
func (x *SamplingParams) GetTopK() float64 {
	if x != nil && x.TopK != nil {
		return *x.TopK
	}
	return 0
...
type ModelParams struct {
	...
	Sampling        *SamplingParams  `protobuf:"bytes,1,opt,name=sampling,proto3,oneof" json:"sampling,omitempty"`
...
func (x *ModelParams) GetSampling() *SamplingParams {
	if x != nil {
		return x.Sampling
	}
	return nil
...
type LogProbs struct {
	...
	Top          []*TokenLogProbs `protobuf:"bytes,2,rep,name=top,proto3" json:"top,omitempty"`                                                                  // OAI: top N logprobs
	TextOffset   []uint32         `protobuf:"varint,3,rep,packed,name=text_offset,json=textOffset,proto3" json:"text_offset,omitempty"`                          // OAI: indexed offsets of tokens
	FinishReason FinishReason     `protobuf:"varint,4,opt,name=finish_reason,json=finishReason,proto3,enum=anlatan.FinishReason" json:"finish_reason,omitempty"` // OAI: the reason why this finished if finished
}
...
type Completion struct {
	...
	Index        uint32       `protobuf:"varint,2,opt,name=index,proto3" json:"index,omitempty"`                                                             // OAI: The index the completion starts at.
	Logprobs     *LogProbs    `protobuf:"bytes,3,opt,name=logprobs,proto3" json:"logprobs,omitempty"`                                                        // OAI: Our answer with logprobs
	FinishReason FinishReason `protobuf:"varint,4,opt,name=finish_reason,json=finishReason,proto3,enum=anlatan.FinishReason" json:"finish_reason,omitempty"` // OAI: Why the completions finished.
}
...
var file_completion_proto_rawDesc = []byte{
	...
	0x6b, 0x65, 0x6e, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x61, 0x6e, 0x6c,
	0x61, 0x74, 0x61, 0x6e, 0x2e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x48, 0x00, 0x52, 0x06, 0x74,
	...
	0x6e, 0x6c, 0x61, 0x74, 0x61, 0x6e, 0x2e, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x52, 0x06, 0x74,
	...
	0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x61, 0x6e, 0x6c, 0x61, 0x74,
	0x61, 0x6e, 0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x74, 0x42, 0x69, 0x61, 0x73, 0x52, 0x06, 0x62, 0x69,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
}
...
var file_completion_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_completion_proto_goTypes = []interface{}{
	(FinishReason)(0),       // 0: anlatan.FinishReason
	(SamplingMethod)(0),     // 1: anlatan.SamplingMethod
	(*Token)(nil),           // 2: anlatan.Token
	(*Tokens)(nil),          // 3: anlatan.Tokens
	(*Prompt)(nil),          // 4: anlatan.Prompt
	(*LogitBias)(nil),       // 5: anlatan.LogitBias
	(*LogitBiases)(nil),     // 6: anlatan.LogitBiases
	(*FrequencyParams)(nil), // 7: anlatan.FrequencyParams
	(*ModelTransform)(nil),  // 8: anlatan.ModelTransform
	(*SamplingParams)(nil),  // 9: anlatan.SamplingParams
	(*ModelParams)(nil),     // 10: anlatan.ModelParams
	(*Echo)(nil),            // 11: anlatan.Echo
	(*EngineParams)(nil),    // 12: anlatan.EngineParams
	(*Request)(nil),         // 13: anlatan.Request
	(*LogProb)(nil),         // 14: anlatan.LogProb
	(*TokenLogProbs)(nil),   // 15: anlatan.TokenLogProbs
	(*LogProbs)(nil),        // 16: anlatan.LogProbs
	(*Completion)(nil),      // 17: anlatan.Completion
	(*Answer)(nil),          // 18: anlatan.Answer
}
var file_completion_proto_depIdxs = []int32{
	2,  // 0: anlatan.Tokens.tokens:type_name -> anlatan.Token
	3,  // 1: anlatan.Prompt.tokens:type_name -> anlatan.Tokens
	3,  // 2: anlatan.LogitBias.tokens:type_name -> anlatan.Tokens
	5,  // 3: anlatan.LogitBiases.biases:type_name -> anlatan.LogitBias
	1,  // 4: anlatan.SamplingParams.order:type_name -> anlatan.SamplingMethod
	9,  // 5: anlatan.ModelParams.sampling:type_name -> anlatan.SamplingParams
	7,  // 6: anlatan.ModelParams.frequency_params:type_name -> anlatan.FrequencyParams
	6,  // 7: anlatan.ModelParams.logit_bias:type_name -> anlatan.LogitBiases
	11, // 8: anlatan.EngineParams.echo:type_name -> anlatan.Echo
	4,  // 9: anlatan.EngineParams.stop:type_name -> anlatan.Prompt
	4,  // 10: anlatan.Request.prompt:type_name -> anlatan.Prompt
	10, // 11: anlatan.Request.model_params:type_name -> anlatan.ModelParams
	12, // 12: anlatan.Request.engine_params:type_name -> anlatan.EngineParams
	2,  // 13: anlatan.LogProb.token:type_name -> anlatan.Token
	14, // 14: anlatan.TokenLogProbs.logprobs:type_name -> anlatan.LogProb
	15, // 15: anlatan.LogProbs.tokens:type_name -> anlatan.TokenLogProbs
	15, // 16: anlatan.LogProbs.top:type_name -> anlatan.TokenLogProbs
	0,  // 17: anlatan.LogProbs.finish_reason:type_name -> anlatan.FinishReason
	16, // 18: anlatan.Completion.logprobs:type_name -> anlatan.LogProbs
	0,  // 19: anlatan.Completion.finish_reason:type_name -> anlatan.FinishReason
	17, // 20: anlatan.Answer.choices:type_name -> anlatan.Completion
	13, // 21: anlatan.CompletionService.Completion:input_type -> anlatan.Request
	18, // 22: anlatan.CompletionService.Completion:output_type -> anlatan.Answer
...
func file_completion_proto_init() {
	...
	file_completion_proto_msgTypes[6].OneofWrappers = []interface{}{
		(*ModelTransform_Temperature)(nil),
		(*ModelTransform_TopP)(nil),
		(*ModelTransform_TopK)(nil),
		(*ModelTransform_TailFreeSampling)(nil),
	}
	file_completion_proto_msgTypes[7].OneofWrappers = []interface{}{}
	file_completion_proto_msgTypes[8].OneofWrappers = []interface{}{}
	file_completion_proto_msgTypes[9].OneofWrappers = []interface{}{}
